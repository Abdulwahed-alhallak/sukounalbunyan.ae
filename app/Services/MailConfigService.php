...
class MailConfigService
{
    public static function setDynamicConfig($userId = null)
    {
        ...
        $settings = [
            ...
            'host' => company_setting('email_host', $userId) ?: admin_setting('email_host') ?: 'smtp.sukon.dion.sy',
            ...
            'fromAddress' => company_setting('email_fromAddress', $userId) ?: admin_setting('email_fromAddress') ?: 'noreply@sukon.dion.sy',

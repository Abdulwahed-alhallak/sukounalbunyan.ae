...
## 4. المكونات البصرية (UI Components)
...
| الملف | الدور |
|-------|-------|
| `resources/css/app.css` | التوكنز + سلالم الألوان + Typography + Materials + المكونات |
| `resources/css/css/app.css` | Dark Mode overrides + Sidebar + Scrollbar |

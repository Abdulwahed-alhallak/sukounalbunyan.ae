...
namespace Noble\Performance\Http\Controllers;

use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Performance\Models\PerformanceIndicatorCategory;
use Noble\Performance\Http\Requests\StorePerformanceIndicatorCategoryRequest;
use Noble\Performance\Http\Requests\UpdatePerformanceIndicatorCategoryRequest;
use Noble\Performance\Events\CreatePerformanceIndicatorCategory;
use Noble\Performance\Events\UpdatePerformanceIndicatorCategory;
use Noble\Performance\Events\DestroyPerformanceIndicatorCategory;

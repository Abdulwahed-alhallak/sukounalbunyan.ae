...
use Noble\Performance\Http\Requests\StoreEmployeeGoalRequest;
use Noble\Performance\Http\Requests\UpdateEmployeeGoalRequest;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use App\Models\User;
use Noble\Performance\Events\CreateEmployeeGoal;
use Noble\Performance\Events\UpdateEmployeeGoal;
use Noble\Performance\Events\DestroyEmployeeGoal;

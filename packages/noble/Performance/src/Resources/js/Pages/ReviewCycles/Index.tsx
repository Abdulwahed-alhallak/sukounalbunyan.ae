...
export default function Index() {
    ...
    const handleFilter = () => {
        router.get(
            route('performance.review-cycles.index'),
    ...
    const tableColumns = [
        ...
        ...(auth.user?.permissions?.some((p: string) =>
            ['view-review-cycles', 'edit-review-cycles', 'delete-review-cycles'].includes(p)
        )
            ? [
                  {
                      key: 'actions',
        ...
        <TooltipProvider>
            ...
            >
                        ...
                        <div className="flex items-center justify-between gap-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="relative">
                                    ...
                                    />
                                    {(() => {
                                        const activeFilters = [filters.frequency, filters.status].filter(
                                            Boolean
                                        ).length;
                                        return (
                                            activeFilters > 0 && (
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="min-w-0 flex-1">
                                                            ...
                                                            <p className="truncate text-xs text-muted-foreground">
                                                                {getFrequencyLabel(cycle.frequency)}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <Dialog open={modalState.isOpen} onOpenChange={closeModal}>
                    ...
                    {modalState.mode === 'show' && modalState.data && <Show reviewCycle={modalState.data} />}
                </Dialog>
            </AuthenticatedLayout>
        </TooltipProvider>
    );

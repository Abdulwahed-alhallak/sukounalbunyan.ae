        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/noble/Performance/src/marketplace/' . $file->getFilename();
                }
            }
        }
        ...
        MarketplaceSetting::firstOrCreate(['module' => 'Performance'], [
            ...
            'config_sections' => [
                'sections'           => [
                    'hero'        => [
                        'variant'               => 'hero1',
                        'title'                 => 'Performance Management System forNobleArchitecture',
                    ...
                    'dedication'  => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'screenshot'  => '/packages/noble/Performance/src/marketplace/image1.png'
                            ],
                            [
                                ...
                                'screenshot'  => '/packages/noble/Performance/src/marketplace/image2.png'
                            ],
                            [
                                ...
                                'screenshot'  => '/packages/noble/Performance/src/marketplace/image3.png'
                            ]
                        ]
                    ],
                    'screenshots' => [

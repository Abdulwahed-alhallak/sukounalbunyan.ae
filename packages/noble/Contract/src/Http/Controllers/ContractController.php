...
namespace Noble\Contract\Http\Controllers;

use Noble\Contract\Models\Contract;
use Noble\Contract\Http\Requests\StoreContractRequest;
use Noble\Contract\Http\Requests\UpdateContractRequest;
use Noble\Contract\Http\Requests\DuplicateContractRequest;
use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use App\Models\User;
use Noble\Contract\Events\StatusChangeContract;
use Noble\Contract\Events\CreateContract;
use Noble\Contract\Events\UpdateContract;
use Noble\Contract\Events\DestroyContract;

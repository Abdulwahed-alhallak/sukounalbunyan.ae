                ...
                <div className="space-y-6">
                    ...
                    <div className="rounded-lg border bg-muted/30 p-4">
                        ...
                        <div className="space-y-1 text-sm text-muted-foreground">
                            <div>
                                {t('Contract Prefix')}:{' '}
                                <span className="font-medium text-foreground">{settings.contract_prefix}</span>
                            </div>
                            <div>
                                {t('Next Contract Number')}:{' '}
                                <span className="font-medium text-foreground">{settings.contract_prefix}0001</span>
                            </div>
                        </div>
                    </div>
                </div>

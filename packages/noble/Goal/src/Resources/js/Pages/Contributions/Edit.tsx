        ...
        <DialogContent className="max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    ...
                    <Select
                        value={data.goal_id.toString()}
                        onValueChange={(value) => setData('goal_id', parseInt(value))}
                    >
                        <SelectTrigger>
                ...
                <div>
                    <Label htmlFor="contribution_date" required>
                        {t('Date')}
                    </Label>
                    <DatePicker
                    ...
                    />
                    {errors.contribution_date && <p className="text-sm text-destructive">{errors.contribution_date}</p>}
                </div>

                <div>
                    <Label htmlFor="contribution_amount" required>
                        {t('Amount')}
                    </Label>
                    <CurrencyInput
                    ...
                    {errors.contribution_amount && (
                        <p className="text-sm text-destructive">{errors.contribution_amount}</p>
                    )}
                </div>

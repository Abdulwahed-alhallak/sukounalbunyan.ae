...
use Noble\Goal\Http\Requests\StoreCategoryRequest;
use Noble\Goal\Http\Requests\UpdateCategoryRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Goal\Models\GoalCategory;
use Noble\Goal\Events\CreateGoalCategory;
use Noble\Goal\Events\UpdateGoalCategory;
use Noble\Goal\Events\DestroyGoalCategory;

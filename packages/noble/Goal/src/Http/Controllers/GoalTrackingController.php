...
use Noble\Goal\Http\Requests\StoreTrackingRequest;
use Noble\Goal\Http\Requests\UpdateTrackingRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Goal\Models\Goal;
use Noble\Goal\Models\GoalTracking;
use Noble\Goal\Events\CreateGoalTracking;
use Noble\Goal\Events\UpdateGoalTracking;
use Noble\Goal\Events\DestroyGoalTracking;

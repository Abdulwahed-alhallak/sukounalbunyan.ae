...
namespace Noble\Goal\Http\Controllers;

use Noble\Goal\Http\Requests\StoreContributionRequest;
use Noble\Goal\Http\Requests\UpdateContributionRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Goal\Models\Goal;
use Noble\Goal\Models\GoalContribution;
use Noble\Goal\Events\CreateGoalContribution;
use Noble\Goal\Events\UpdateGoalContribution;
use Noble\Goal\Events\DestroyGoalContribution;

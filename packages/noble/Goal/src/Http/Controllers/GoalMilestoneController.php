...
use Noble\Goal\Http\Requests\StoreMilestoneRequest;
use Noble\Goal\Http\Requests\UpdateMilestoneRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Goal\Models\Goal;
use Noble\Goal\Models\GoalMilestone;
use Noble\Goal\Events\CreateGoalMilestone;
use Noble\Goal\Events\UpdateGoalMilestone;
use Noble\Goal\Events\DestroyGoalMilestone;

...
use Noble\Goal\Http\Requests\StoreGoalRequest;
use Noble\Goal\Http\Requests\UpdateGoalRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Goal\Models\Goal;
use Noble\Goal\Models\GoalCategory;
use Noble\Goal\Events\CreateGoal;
use Noble\Goal\Events\UpdateGoal;
use Noble\Goal\Events\DestroyGoal;

...
use Inertia\Inertia;
use App\Models\User;
use Noble\Training\Events\CreateTrainingTask;
use Noble\Training\Events\UpdateTrainingTask;
use Noble\Training\Events\DestroyTrainingTask;
use Noble\Training\Http\Requests\StoreTrainingTaskRequest;
use Noble\Training\Http\Requests\UpdateTrainingTaskRequest;

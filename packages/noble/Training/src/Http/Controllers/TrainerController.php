...
use Noble\Training\Http\Requests\StoreTrainerRequest;
use Noble\Training\Http\Requests\UpdateTrainerRequest;
use Noble\Training\Events\CreateTrainer;
use Noble\Training\Events\UpdateTrainer;
use Noble\Training\Events\DestroyTrainer;

    ...
    public function run($userId)
    {
        ...
        foreach ($trainerData as $index => $data) {
            ...
            if (Module_is_active('Hrm')) {
                ...
                $userBranches = \Noble\Hrm\Models\Branch::where('created_by', $userId)->pluck('id')->toArray();
                ...
                if (!empty($userBranches)) {
                    ...
                    $branchDepartments = \Noble\Hrm\Models\Department::where('branch_id', $actualBranchId)

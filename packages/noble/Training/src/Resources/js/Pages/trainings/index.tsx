...
export default function Index() {
    ...
    const {
        ...
        users = [],
        auth,
    } = usePage<TrainingsIndexProps>().props;
    ...
    const tableColumns = [
        ...
        ...(auth.user?.permissions?.some((p: string) =>
            ['manage-training-tasks', 'edit-trainings', 'delete-trainings'].includes(p)
        )
            ? [
                  {
                      key: 'actions',
                                      ...
                                      <Tooltip delayDuration={0}>
                                          <TooltipTrigger asChild>
                                              <Button
                                                  ...
                                                  size="sm"
                                                  onClick={() =>
                                                      router.visit(route('training.trainings.tasks.index', training.id))
                                                  }
    ...
    return (
        <AuthenticatedLayout
            breadcrumbs={[{ label: t('Training') }, { label: t('Training List') }]}
                                            ...
                                            <div className="p-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p
                                                                ...
                                                                title={
                                                                    training.trainingType?.name ||
                                                                    trainingTypes.find(
                                                                        (type) => type.id === training.training_type_id
                                                                    )?.name
                                                                }
                                                            >
                                                                {training.trainingType?.name ||
                                                ...
                                                <div className="flex items-center justify-between border-t pt-3">
                                                    {(() => {
                                                        ...
                                                        return (
                                                            <span
                                                                className={`rounded-full px-2 py-1 text-xs ${statusColors[training.status as keyof typeof statusColors]}`}
                                                            >
                                                                {t(
                                                                    ...
                                                                    <TooltipTrigger asChild>
                                                                        <Button
                                                                            ...
                                                                            onClick={() =>
                                                                                router.visit(
                                                                                    route(
                                                                                        'training.trainings.tasks.index',
                                                                                        training.id
                                                                                    )
                                                                                )
                                                                            }

...
use Noble\SupportTicket\Http\Controllers\ContactController;
use Noble\SupportTicket\Http\Controllers\ConversationController;
use Noble\SupportTicket\Http\Controllers\CustomPageController;
use Noble\SupportTicket\Http\Controllers\DashboardController;
use Noble\SupportTicket\Http\Controllers\FaqController;
use Noble\SupportTicket\Http\Controllers\FrontendController;
use Noble\SupportTicket\Http\Controllers\KnowledgebaseCategoryController;
use Noble\SupportTicket\Http\Controllers\KnowledgeController;
use Noble\SupportTicket\Http\Controllers\SupportTicketController;
use Noble\SupportTicket\Http\Controllers\TicketCategoryController;
use Noble\SupportTicket\Http\Controllers\Company\SettingsController;
use Noble\SupportTicket\Http\Controllers\SupportTicketSettingController;
use Noble\SupportTicket\Http\Controllers\TitleSectionController;
use Noble\SupportTicket\Http\Controllers\CtaSectionController;
use Noble\SupportTicket\Http\Controllers\QuickLinkController;
use Noble\SupportTicket\Http\Controllers\SupportInformationController;
use Noble\SupportTicket\Http\Controllers\ContactInformationController;
use Noble\SupportTicket\Http\Middleware\SupportTicketSharedDataMiddleware;

...
export default function Layout({ children, title = "Support Ticket", brandSettings }: SupportTicketLayoutProps) {
    ...
    return (
        <>
            <Head title={title}>
                <link rel="icon" type="image/png" href={brandSettings?.favicon || '/packages/noble/SupportTicket/src/Resources/assets/images/favicon.png'} />
            </Head>
            ...
            <div className="min-h-screen font-sans relative overflow-x-hidden" style={{
                ...
                <div className="container mx-auto px-4 py-4 max-w-7xl relative z-10">
                            ...
                            <div className="flex flex-wrap justify-between items-center">
                                ...
                                <h1>
                                    <a href="#" className="flex items-center space-x-3 lg:max-w-none max-w-[120px]">
                                        <img src={brandSettings?.logo_dark || '/packages/noble/SupportTicket/src/Resources/assets/images/logo.png'} alt="Noble Architecture Support" className="h-8" />
                                    </a>
                                </h1>
                                ...
                                <div className="main-nav hidden md:block">
                                    <nav className="flex flex-wrap justify-center md:gap-3 lg:gap-4">
                                        <a href="#" className="text-background transition font-medium lg:text-lg duration-300 flex items-center hover:text-muted-foreground/40">
                                            {t('Create Ticket')}
                                        </a>
                                        <a href="#" className="text-background transition font-medium lg:text-lg duration-300 flex items-center hover:text-muted-foreground/40">
                                            {t('Search Tickets')}
                                        ...
                                        <a href="#" className="text-background transition font-medium duration-300 lg:text-lg flex items-center hover:text-muted-foreground/40">
                                            {t('FAQ')}
                                        </a>
                                    </nav>
                                </div>
                                ...
                                <div className="hidden md:flex items-center space-x-3">
                                    <Button variant="secondary" size="sm" className="bg-card text-foreground hover:bg-muted">
                        ...
                        {mobileMenuOpen && (
                            <div className="bg-card rounded-xl shadow-lg mb-4 p-4 md:hidden">
                                <nav className="flex flex-col space-y-2">
                                    <a href="#" className="text-foreground rounded-lg transition duration-300 flex items-center p-2">
                                        <Ticket className="h-4 w-4 mr-2" /> {t('Create Ticket')}
                                    </a>
                                    <a href="#" className="text-foreground rounded-lg hover:text-foreground transition duration-300 flex items-center p-2">
                    ...
                    <footer className="mt-8 md:mt-12 text-center text-muted-foreground text-sm">
                        <p>{t(`© ${new Date().getFullYear()} Noble Architecture Support System. All rights reserved.`)}</p>
                        <div className="mt-2 flex flex-wrap justify-center space-x-4">
                            <a href="#" className="hover:text-foreground transition-colors duration-200">{t('Privacy Policy')}</a>
                            <a href="#" className="hover:text-foreground transition-colors duration-200">{t('Terms of Service')}</a>
                            <a href="#" className="hover:text-foreground transition-colors duration-200">{t('Contact Us')}</a>
                        </div>
                    </footer>
                </div>
            </div>

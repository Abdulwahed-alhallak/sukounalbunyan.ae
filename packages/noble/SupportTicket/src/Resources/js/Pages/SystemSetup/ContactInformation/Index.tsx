...
export default function ContactInformation({ contactInformation }: ContactInformationProps) {
    ...
    const defaultData = {
        map_embed_url:
            contactInformation?.map_embed_url ??
            '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d9581841.830083132!2d-14.999203219951713!3d54.10358663935295!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x25a3b1142c791a9%3A0xc4f8a0433288257a!2sUnited%20Kingdom!5e0!3m2!1sen!2sin!4v1762249682876!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>',
                        ...
                        <CardContent className="p-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        <Label htmlFor="map_embed_url" required>
                                            {t('Google Maps Embed URL')}
                                        </Label>
                                        <Textarea
                                            id="map_embed_url"
                                        ...
                                        {errors.map_embed_url && (
                                            <p className="mt-1 text-sm text-destructive">{errors.map_embed_url}</p>
                                        )}
                                    </div>
                                </div>

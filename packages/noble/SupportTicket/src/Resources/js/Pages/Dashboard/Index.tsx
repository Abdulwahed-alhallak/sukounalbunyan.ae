...
export default function Index({ stats, chartData, monthlyData, recentTickets, statusData, slug }: DashboardProps) {
    ...
    return (
        <AuthenticatedLayout
            breadcrumbs={[{ label: t('Support Tickets Dashboard') }]}
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6">
                    ...
                    >
                        ...
                        <CardContent>
                            ...
                            <p className="mt-1 text-xs text-foreground">{t('All time')}</p>
                        </CardContent>
                    </Card>
                    ...
                    >
                        ...
                        <CardContent>
                            ...
                            <p className="mt-1 text-xs text-foreground">{t('Pending resolution')}</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="border-border bg-gradient-to-r from-muted/50 to-muted">
                        ...
                        <CardContent>
                            ...
                            <p className="mt-1 text-xs text-foreground">{t('Response time')}</p>
                        </CardContent>
                    </Card>

                    <Card
                        className="cursor-pointer border-border bg-gradient-to-r from-muted/50 to-muted transition-all duration-200 hover:shadow-lg"
                        onClick={() => router.get(route('ticket-category.index'))}
                    >
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        ...
                        <CardContent>
                            ...
                            <p className="mt-1 text-xs text-destructive">{t('Active categories')}</p>
                        </CardContent>
                    </Card>
                </div>

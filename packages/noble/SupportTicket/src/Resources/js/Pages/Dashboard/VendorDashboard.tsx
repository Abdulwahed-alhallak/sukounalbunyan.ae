...
export default function VendorDashboard({ stats, monthlyData, recentTickets, statusData, slug }: VendorDashboardProps) {
    ...
    return (
        <AuthenticatedLayout breadcrumbs={[{ label: t('Vendor Dashboard') }]} pageTitle={t('Vendor Dashboard')}>
                    ...
                    <CardContent className="relative p-8">
                        <div className="flex items-center justify-between">
                            <div className="space-y-4">
                                <h2 className="text-2xl font-bold text-foreground">{t('Vendor Support Portal')}</h2>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card className="border-border bg-gradient-to-r from-muted/50 to-muted">
                        ...
                        <CardContent>
                            ...
                            <p className="mt-1 text-xs text-foreground">{t('Active requests')}</p>
                        </CardContent>
                    </Card>

    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-card shadow-lg rounded-2xl border-0 hover:shadow-xl transition-all duration-300">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-muted-foreground">{t('My Tickets')}</p>
                  <p className="text-3xl font-bold text-foreground mt-2">{stats.totalTickets}</p>
                  <p className="text-xs text-muted-foreground mt-1">{t('Total submitted')}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-muted-foreground mt-2">{stats.openTickets}</p>
                  <p className="text-xs text-muted-foreground mt-1">{t('Being resolved')}</p>
                </div>
                <div className="bg-muted p-3 rounded-full">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-foreground mt-2">{stats.closedTickets}</p>
                  <p className="text-xs text-muted-foreground mt-1">{stats.resolutionRate}% {t('success rate')}</p>
                </div>
                <div className="bg-muted p-3 rounded-full">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-foreground mt-2">{stats.todayTickets}</p>
                  <p className="text-xs text-muted-foreground mt-1">{t('New requests')}</p>
                </div>
                <div className="bg-muted p-3 rounded-full">
            ...
            {recentTickets && recentTickets.length > 0 ? (
              <div className="space-y-4">
                {recentTickets?.map((ticket) => (
                  <div key={ticket.id} className="flex items-center justify-between p-4 bg-muted/50 rounded-lg hover:bg-muted transition-colors cursor-pointer">

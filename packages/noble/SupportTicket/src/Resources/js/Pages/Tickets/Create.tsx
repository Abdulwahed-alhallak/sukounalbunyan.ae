...
export default function Create({ categories, staff, clients, vendors, allFields, customFields }: CreateProps) {
    ...
    return (
        <AuthenticatedLayout
            breadcrumbs={[{ label: t('Support Tickets'), url: route('support-tickets.index') }, { label: t('Create') }]}
                                    ...
                                    ?.map((field) => {
                                        ...
                                        if (field.custom_id == 4) {
                                            ...
                                            return (
                                                <>
                                                    <div key={field.id} className="col-span-6">
                                                        <Label htmlFor="subject" required={field.is_required}>
                                                            {t(field.name)}
                                                        </Label>
                                                        <Input
                                                            id="subject"
                                        ...
                                        if (field.custom_id == 5) {
                                            ...
                                            return (
                                                <div key={field.id} className="col-span-12">
                                                    <Label htmlFor="description" required={field.is_required}>
                                                        {t(field.name)}
                                                    </Label>
                                                    <RichTextEditor
                                        ...
                                        if (field.custom_id == 6) {
                                            ...
                                            return (
                                                <div key={field.id} className="col-span-12">
                                                    <Label>
                                                        {t(field.name)} <small>({t(field.placeholder)})</small>
                                                    </Label>
                                                    <MediaPicker
                                                        value={data.attachments}
                                                        onChange={(files) =>
                                                            setData('attachments', Array.isArray(files) ? files : [])
                                                        }
                                        ...
                                        if (field.custom_id > 6 && field.type === 'text') {
                                            return (
                                                <div key={field.id} className="col-span-6">
                                                    <Label htmlFor={`field-${field.id}`} required={field.is_required}>
                                                        {t(field.name)}
                                                    </Label>
                                                    <Input
                                                        id={`field-${field.id}`}

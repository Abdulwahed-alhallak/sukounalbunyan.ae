                ...
                <CardContent>
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            {data.account_type !== 'custom' && (
                                <div>
                                    ...
                                    <Select value={data.user_id?.toString() || ''} onValueChange={handleUserChange}>
                                        <SelectTrigger>
                        ...
                        <div>
                            ...
                            <div className="mt-2">
                                <label className="flex h-32 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-border bg-muted/50 hover:bg-muted">

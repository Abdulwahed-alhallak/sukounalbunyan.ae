                ...
                emptyState={
                  <div className="flex flex-col items-center justify-center py-12">
                    <div className="text-center">
                      ...
                      <h3 className="text-lg font-medium text-foreground mb-2">{t('No Knowledge Base found')}</h3>
                      <p className="text-muted-foreground mb-4">{t('Get started by creating your first Knowledge Base article.')}</p>

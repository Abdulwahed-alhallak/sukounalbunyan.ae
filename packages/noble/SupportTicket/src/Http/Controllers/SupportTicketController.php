...
use Noble\SupportTicket\Events\CreateTicket;
use Noble\SupportTicket\Events\CreateTicketConversion;
use Noble\SupportTicket\Events\DestroyTicket;
use Noble\SupportTicket\Events\UpdateTicket;
use Noble\SupportTicket\Http\Requests\StoreSupportTicketRequest;
use Noble\SupportTicket\Http\Requests\UpdateSupportTicketRequest;
use Noble\SupportTicket\Http\Requests\StoreConversionRequest;
use Noble\SupportTicket\Models\Ticket;
use Noble\SupportTicket\Models\TicketCategory;
...
class SupportTicketController extends Controller
{
    ...
    private function getBrandSettings()
    {
        ...
        return [
            'logo_dark' => $settings['logo_dark'] ?? asset('packages/noble/SupportTicket/src/Resources/assets/images/logo.png'),
            'favicon' => $settings['favicon'] ?? '/packages/noble/SupportTicket/src/Resources/assets/images/favicon.png',

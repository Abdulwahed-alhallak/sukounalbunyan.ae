...
namespace Noble\Quotation\Database\Seeders;
        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/noble/Quotation/src/marketplace/' . $file->getFilename();
                }
            }
        }
        ...
        MarketplaceSetting::firstOrCreate(['module' => 'Quotation'], [
            ...
            'config_sections' => [
                'sections' => [
                    'hero' => [
                        'variant' => 'hero1',
                        'title' => 'Quotation Module forNobleArchitecture',
                    ...
                    'dedication' => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'screenshot' => '/packages/noble/Quotation/src/marketplace/image1.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/noble/Quotation/src/marketplace/image2.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/noble/Quotation/src/marketplace/image3.png'
                            ]
                        ]
                    ],
                    'screenshots' => [

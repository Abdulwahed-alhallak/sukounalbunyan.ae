...
export default function Print() {
    ...
    return (
        <div className="min-h-screen bg-card">
            ...
            <div className="quotation-container mx-auto max-w-4xl bg-card p-12">
                <div className="mb-12 flex items-start justify-between">
                    ...
                    <div className="w-1/2 text-end">
                        <h2 className="mb-2 text-2xl font-bold">{t('QUOTATION')}</h2>
                        ...
                        <div className="mt-2 space-y-1 text-sm">
                            ...
                            <p>
                                {t('Due Date')}: {formatDate(quotation.due_date)}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mb-12 flex justify-between">
                    <div className="w-1/2">
                        <h3 className="mb-3 font-bold">{t('QUOTE TO')}</h3>
                        <div className="space-y-1 text-sm">
                    ...
                    <div className="w-1/2 text-end">
                        ...
                        <div className="space-y-1 text-sm">
                            {quotation.customer_details?.shipping_address ? (
                                ...
                                <p className="text-muted-foreground">{t('Same as billing address')}</p>
                            )}
                        </div>
                    </div>
                </div>
                ...
                <div className="border-t border-border pt-6 text-center">
                    <p className="font-semibold">
                        {t('PAYMENT TERMS')}: {quotation.payment_terms || t('Net 30 Days')}
                    </p>

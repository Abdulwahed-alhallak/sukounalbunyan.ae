                            ...
                            <table className="w-full">
                                ...
                                <tbody>
                                    {Object.entries(data.grouped)?.map(([type, group]) => (
                                        <>
                                            <tr key={`header-${type}`} className={`${typeColors[type as keyof typeof typeColors] || 'bg-muted/50'} font-semibold`}>
                                            ...
                                            <tr key={`subtotal-${type}`} className="bg-muted font-semibold border-t-2">

...
namespace Noble\BudgetPlanner\Http\Controllers;

use Noble\BudgetPlanner\Models\BudgetPeriod;
use Noble\BudgetPlanner\Http\Requests\StoreBudgetPeriodRequest;
use Noble\BudgetPlanner\Http\Requests\UpdateBudgetPeriodRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use App\Models\User;
use Noble\BudgetPlanner\Events\ActiveBudgetPeriod;
use Noble\BudgetPlanner\Events\ApproveBudgetPeriod;
use Noble\BudgetPlanner\Events\CloseBudgetPeriod;
use Noble\BudgetPlanner\Events\CreateBudgetPeriod;
use Noble\BudgetPlanner\Events\DestroyBudgetPeriod;
use Noble\BudgetPlanner\Events\UpdateBudgetPeriod;

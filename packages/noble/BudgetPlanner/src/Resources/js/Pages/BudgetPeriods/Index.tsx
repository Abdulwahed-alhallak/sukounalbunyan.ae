                        ...
                        <div className="flex gap-1">
                            <TooltipProvider>
                                ...
                                {budgetperiod.status === 'draft' && auth.user?.permissions?.includes('edit-budget-periods') && (
                                    <Tooltip delayDuration={0}>
                                        <TooltipTrigger asChild>
                                            <Button variant="ghost" size="sm" onClick={() => openModal('edit', budgetperiod)} className="h-8 w-8 p-0 text-foreground hover:text-foreground">
                ...
                {showFilters && (
                    <CardContent className="p-6 bg-muted/50/30 border-b">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div>
                                <label className="block text-sm font-medium text-foreground mb-2">{t('Financial Year')}</label>
                                <Input

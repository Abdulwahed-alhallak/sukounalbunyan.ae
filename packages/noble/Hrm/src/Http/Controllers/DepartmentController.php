...
use Noble\Hrm\Http\Requests\StoreDepartmentRequest;
use Noble\Hrm\Http\Requests\UpdateDepartmentRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Hrm\Models\Branch;
use Noble\Hrm\Models\Department;
use Noble\Hrm\Events\CreateDepartment;
use Noble\Hrm\Events\DestroyDepartment;
use Noble\Hrm\Events\UpdateDepartment;

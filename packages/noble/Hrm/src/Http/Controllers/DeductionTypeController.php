...
use Noble\Hrm\Http\Requests\StoreDeductionTypeRequest;
use Noble\Hrm\Http\Requests\UpdateDeductionTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Hrm\Events\CreateDeductionType;
use Noble\Hrm\Events\DestroyDeductionType;
use Noble\Hrm\Events\UpdateDeductionType;

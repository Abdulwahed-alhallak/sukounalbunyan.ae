...
use Noble\Hrm\Http\Requests\StoreShiftRequest;
use Noble\Hrm\Http\Requests\UpdateShiftRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use App\Models\User;
use Noble\Hrm\Events\CreateShift;
use Noble\Hrm\Events\UpdateShift;
use Noble\Hrm\Events\DestroyShift;
...
class ShiftController extends Controller
{
    ...
    public function scheduler()
    {
        if (Auth::user()->can('manage-shifts')) {
            ...
            $employees = \Noble\Hrm\Models\Employee::with(['user', 'shift'])

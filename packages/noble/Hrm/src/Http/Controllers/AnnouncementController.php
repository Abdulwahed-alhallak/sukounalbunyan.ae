...
use Noble\Hrm\Http\Requests\StoreAnnouncementRequest;
use Noble\Hrm\Http\Requests\UpdateAnnouncementRequest;
...
use Noble\Hrm\Events\DestroyAnnouncement;
use Noble\Hrm\Events\UpdateAnnouncement;
            ...
            $announcements = Announcement::query()
                ...
                ->where(function ($q) {
                    if (Auth::user()->can('manage-any-announcements')) {
                        ...
                        $employee = \Noble\Hrm\Models\Employee::where('user_id', Auth::id())->first();

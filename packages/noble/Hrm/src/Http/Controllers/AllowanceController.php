...
use Noble\Hrm\Http\Requests\StoreAllowanceRequest;
use Noble\Hrm\Http\Requests\UpdateAllowanceRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Illuminate\Http\Request;
use Noble\Hrm\Events\CreateAllowance;
use Noble\Hrm\Events\UpdateAllowance;
use Noble\Hrm\Events\DestroyAllowance;

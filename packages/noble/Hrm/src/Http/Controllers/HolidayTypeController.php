...
use Noble\Hrm\Http\Requests\StoreHolidayTypeRequest;
use Noble\Hrm\Http\Requests\UpdateHolidayTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Hrm\Events\CreateHolidayType;
use Noble\Hrm\Events\DestroyHolidayType;
use Noble\Hrm\Events\UpdateHolidayType;

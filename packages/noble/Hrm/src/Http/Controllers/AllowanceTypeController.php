...
use Noble\Hrm\Http\Requests\StoreAllowanceTypeRequest;
use Noble\Hrm\Http\Requests\UpdateAllowanceTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Hrm\Events\CreateAllowanceType;
use Noble\Hrm\Events\DestroyAllowanceType;
use Noble\Hrm\Events\UpdateAllowanceType;

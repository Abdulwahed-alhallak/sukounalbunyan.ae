...
use Noble\Hrm\Http\Requests\StoreHrmDocumentRequest;
use Noble\Hrm\Http\Requests\UpdateHrmDocumentRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Hrm\Models\DocumentCategory;
use Noble\Hrm\Events\CreateDocument;
use Noble\Hrm\Events\DestroyDocument;
use Noble\Hrm\Events\UpdateDocument;

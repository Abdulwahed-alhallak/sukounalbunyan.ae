...
use Noble\Hrm\Http\Requests\StoreLoanTypeRequest;
use Noble\Hrm\Http\Requests\UpdateLoanTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Hrm\Events\CreateLoanType;
use Noble\Hrm\Events\DestroyLoanType;
use Noble\Hrm\Events\UpdateLoanType;

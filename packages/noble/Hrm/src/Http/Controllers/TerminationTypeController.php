...
use Noble\Hrm\Http\Requests\StoreTerminationTypeRequest;
use Noble\Hrm\Http\Requests\UpdateTerminationTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Hrm\Events\CreateTerminationType;
use Noble\Hrm\Events\DestroyTerminationType;
use Noble\Hrm\Events\UpdateTerminationType;

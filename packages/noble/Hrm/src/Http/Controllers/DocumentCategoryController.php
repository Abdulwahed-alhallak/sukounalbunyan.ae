...
use Noble\Hrm\Http\Requests\StoreDocumentCategoryRequest;
use Noble\Hrm\Http\Requests\UpdateDocumentCategoryRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Hrm\Events\CreateDocumentCategory;
use Noble\Hrm\Events\DestroyDocumentCategory;
use Noble\Hrm\Events\UpdateDocumentCategory;

...
use Noble\Hrm\Http\Requests\StoreHolidayRequest;
use Noble\Hrm\Http\Requests\UpdateHolidayRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Hrm\Events\CreateHoliday;
use Noble\Hrm\Events\DestroyHoliday;
use Noble\Hrm\Events\UpdateHoliday;

...
use Noble\Hrm\Http\Requests\StoreAwardTypeRequest;
use Noble\Hrm\Http\Requests\UpdateAwardTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Hrm\Events\CreateAwardType;
use Noble\Hrm\Events\DestroyAwardType;
use Noble\Hrm\Events\UpdateAwardType;

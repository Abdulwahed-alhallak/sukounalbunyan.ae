...
use Noble\Hrm\Http\Requests\StorePromotionRequest;
use Noble\Hrm\Http\Requests\UpdatePromotionRequest;
...
use Noble\Hrm\Events\CreatePromotion;
use Noble\Hrm\Events\DestroyPromotion;
use Noble\Hrm\Events\UpdatePromotion;

...
use Noble\Hrm\Http\Requests\StoreComplaintTypeRequest;
use Noble\Hrm\Http\Requests\UpdateComplaintTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Hrm\Events\CreateComplaintType;
use Noble\Hrm\Events\DestroyComplaintType;
use Noble\Hrm\Events\UpdateComplaintType;

...
use Noble\Hrm\Http\Requests\StoreDesignationRequest;
use Noble\Hrm\Http\Requests\UpdateDesignationRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Hrm\Models\Branch;
use Noble\Hrm\Models\Department;
use Noble\Hrm\Events\CreateDesignation;
use Noble\Hrm\Events\DestroyDesignation;
use Noble\Hrm\Events\UpdateDesignation;

...
use Noble\Hrm\Http\Requests\StoreEventTypeRequest;
use Noble\Hrm\Http\Requests\UpdateEventTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Hrm\Events\CreateEventType;
use Noble\Hrm\Events\DestroyEventType;
use Noble\Hrm\Events\UpdateEventType;

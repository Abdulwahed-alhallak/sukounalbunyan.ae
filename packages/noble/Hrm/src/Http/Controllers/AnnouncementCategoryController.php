...
use Noble\Hrm\Http\Requests\StoreAnnouncementCategoryRequest;
use Noble\Hrm\Http\Requests\UpdateAnnouncementCategoryRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Hrm\Events\CreateAnnouncementCategory;
use Noble\Hrm\Events\DestroyAnnouncementCategory;
use Noble\Hrm\Events\UpdateAnnouncementCategory;

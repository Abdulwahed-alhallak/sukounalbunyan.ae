...
use Noble\Hrm\Http\Requests\StoreWarningTypeRequest;
use Noble\Hrm\Http\Requests\UpdateWarningTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Hrm\Events\CreateWarningType;
use Noble\Hrm\Events\DestroyWarningType;
use Noble\Hrm\Events\UpdateWarningType;

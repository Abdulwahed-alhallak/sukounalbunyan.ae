...
use Noble\Hrm\Http\Requests\StoreAttendanceRequest;
use Noble\Hrm\Http\Requests\UpdateAttendanceRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Hrm\Models\Employee;
use Noble\Hrm\Models\Shift;
use Noble\Hrm\Events\CreateAttendance;
use Noble\Hrm\Events\UpdateAttendance;
use Noble\Hrm\Events\DestroyAttendance;
use Noble\Hrm\Models\LeaveApplication;
use Noble\Hrm\Models\Holiday;
use Noble\Hrm\Models\IpRestrict;

...
use Noble\Hrm\Http\Requests\StoreWarningRequest;
use Noble\Hrm\Http\Requests\UpdateWarningRequest;
...
use Noble\Hrm\Events\CreateWarning;
use Noble\Hrm\Events\DestroyWarning;
use Noble\Hrm\Events\UpdateWarning;

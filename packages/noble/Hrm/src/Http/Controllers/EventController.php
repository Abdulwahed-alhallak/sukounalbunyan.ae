...
use Noble\Hrm\Http\Requests\StoreEventRequest;
use Noble\Hrm\Http\Requests\UpdateEventRequest;
...
use Noble\Hrm\Events\DestroyEvent;
use Noble\Hrm\Events\UpdateEvent;

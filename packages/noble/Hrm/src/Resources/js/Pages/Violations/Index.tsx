...
export default function Index() {
    ...
    const handleViolationTypeChange = (typeId: string) => {
        ...
        setForm({
            ...
            deduction_amount: type?.default_deduction_amount
                ? String(type.default_deduction_amount)
        ...
        >
            ...
            <div className="space-y-6">
                <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            {t('Manage and define employee policy violations and corresponding actions/deductions.')}
                        </p>
                    </div>
                ...
                <Card>
                    ...
                    <CardContent className="p-0 sm:p-6 sm:pt-0">
                                        ...
                                        data.map((violation) => (
                                            <TableRow key={violation.id}>
                                                <TableCell className="font-medium">
                                                    {violation.employee?.name || t('Unknown')}
                                                </TableCell>
                                                <TableCell>{violation.violation_type?.name || t('Custom')}</TableCell>
                                                <TableCell>
                                                    <Badge
                                                        variant={
                                                            violation.violation_type?.severity === 'critical'
                                                                ? 'destructive'
                                                                : violation.violation_type?.severity === 'high'
                                                                  ? 'destructive'
                                                                  : 'secondary'
                                                        }
                                                    >
                                        ...
                                        <TableRow>
                                            <TableCell colSpan={7} className="h-32 text-center">
                                                <div className="flex flex-col items-center justify-center text-muted-foreground">
                                                    <HelpCircle className="mb-2 h-10 w-10 opacity-20" />
                        ...
                        {violations && violations.last_page > 1 && (
                            <div className="mt-4">
            ...
            >
                <DialogContent className="max-h-[90vh] max-w-xl overflow-y-auto">
                    <DialogHeader>
                        <DialogTitle>{editingItem ? t('Edit Violation') : t('Record New Violation')}</DialogTitle>
                    </DialogHeader>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                ...
                                rows={3}
                                placeholder={t('Enter incident details...')}
                            />
                        </div>
                        <DialogFooter>
                            <Button
            ...
            <ConfirmationDialog
                ...
                message={t('Are you sure you want to delete this violation record?')}
            />
        </AuthenticatedLayout>
    );
}

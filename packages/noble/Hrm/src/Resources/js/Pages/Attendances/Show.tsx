                    ...
                    <div>
                        ...
                        <div className="mt-1">
                            <span className={`px-2 py-1 rounded-full text-sm ${
                                attendance.status === 'present' ? 'bg-muted text-foreground' :
                                attendance.status === 'half day' ? 'bg-muted text-foreground' :
                                attendance.status === 'absent' ? 'bg-muted text-destructive' :

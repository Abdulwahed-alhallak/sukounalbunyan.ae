                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                            ...
                            <div className="mt-1">
                                {announcement.priority ? (
                                    <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold ${
                                        announcement.priority === 'low' ? 'bg-muted text-foreground' :
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                {announcement.status ? (
                                    <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold ${
                                        announcement.status === 'active' ? 'bg-muted text-foreground' :
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <p className={`mt-1 font-medium ${announcement.end_date && new Date(announcement.end_date) < new Date() ? 'text-destructive' : ''}`}>

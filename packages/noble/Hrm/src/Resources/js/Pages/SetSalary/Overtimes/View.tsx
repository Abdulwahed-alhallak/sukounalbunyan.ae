                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <p className={`mt-1 font-medium ${overtime.end_date && new Date(overtime.end_date) < new Date() ? 'text-destructive' : ''}`}>
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold ${
                                    overtime.status === 'active' ? 'bg-muted text-foreground' : 'bg-muted text-destructive'
                                }`}>

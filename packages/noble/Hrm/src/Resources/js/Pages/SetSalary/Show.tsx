...
import { StatusUpdate as LoanStatusUpdate } from './Loans/StatusUpdate';
...
interface Employee {
    ...
    company?: {
        enable_multi_tier_approval?: string;
    };
}
...
export default function Show() {
    ...
    return (
        ...
        >
            ...
            {loanModalState.mode === 'status' && loanModalState.data && (
                <LoanStatusUpdate
                    open={loanModalState.isOpen}
                    onOpenChange={(open) => !open && closeLoanModal()}
                    loan={loanModalState.data as any}
                    auth={auth}
                    globalSettings={auth.user?.company_settings}
                    isManager={false} // Adjust as needed based on who is viewing
                />
            )}

...
export default function Index() {
    ...
    const tableColumns = [
        ...
        ...(auth.user?.permissions?.some((p: string) =>
            ['edit-document-categories', 'delete-document-categories'].includes(p)
        )
            ? [
                  {
                      key: 'actions',
                                      ...
                                      <Tooltip delayDuration={0}>
                                          <TooltipTrigger asChild>
                                              <Button
                                                  variant="ghost"
                                                  size="sm"
                                                  onClick={() => openModal('edit', documentcategory)}
            ...
            >
                                        ...
                                        <DataTable
                                            ...
                                            emptyState={
                                                <NoRecordsFound
                                                    ...
                                                    description={t(
                                                        'Get started by creating your first DocumentCategory.'
                                                    )}
                ...
                <Dialog open={modalState.isOpen} onOpenChange={closeModal}>
                    ...
                    {modalState.mode === 'edit' && modalState.data && (
                        <EditDocumentCategory documentcategory={modalState.data} onSuccess={closeModal} />
                    )}
                </Dialog>

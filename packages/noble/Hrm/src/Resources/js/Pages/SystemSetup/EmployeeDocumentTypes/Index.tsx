...
export default function Index() {
    ...
    const tableColumns = [
        ...
        ...(auth.user?.permissions?.some((p: string) =>
            ['edit-employee-document-types', 'delete-employee-document-types'].includes(p)
        )
            ? [
                  {
                      key: 'actions',
                                      ...
                                      <Tooltip delayDuration={0}>
                                          <TooltipTrigger asChild>
                                              <Button
                                                  variant="ghost"
                                                  size="sm"
                                                  onClick={() => openModal('edit', employeedocumenttype)}
            ...
            >
                                        ...
                                        <DataTable
                                            ...
                                            emptyState={
                                                <NoRecordsFound
                                                    ...
                                                    description={t(
                                                        'Get started by creating your first EmployeeDocumentType.'
                                                    )}
                ...
                <Dialog open={modalState.isOpen} onOpenChange={closeModal}>
                    ...
                    {modalState.mode === 'edit' && modalState.data && (
                        <EditEmployeeDocumentType employeedocumenttype={modalState.data} onSuccess={closeModal} />
                    )}
                </Dialog>

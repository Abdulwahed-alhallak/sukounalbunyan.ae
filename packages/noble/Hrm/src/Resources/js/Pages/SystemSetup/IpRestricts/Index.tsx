...
export default function Index() {
                                      ...
                                      <Tooltip delayDuration={0}>
                                          <TooltipTrigger asChild>
                                              <Button
                                                  variant="ghost"
                                                  size="sm"
                                                  onClick={() => openModal('edit', iprestrict)}
    ...
    return (
        <TooltipProvider>
            <AuthenticatedLayout
                breadcrumbs={[{ label: t('Hrm') }, { label: t('System Setup') }, { label: t('Ip Restricts') }]}
            ...
            >
                ...
                <Dialog open={modalState.isOpen} onOpenChange={closeModal}>
                    ...
                    {modalState.mode === 'edit' && modalState.data && (
                        <EditIpRestrict iprestrict={modalState.data} onSuccess={closeModal} />
                    )}
                </Dialog>

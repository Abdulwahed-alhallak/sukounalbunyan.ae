...
use Noble\Hrm\Http\Controllers\IpRestrictController;

use Noble\Hrm\Http\Controllers\PayrollController;

use Noble\Hrm\Http\Controllers\LoanTypeController;

use Noble\Hrm\Http\Controllers\DeductionTypeController;

use Noble\Hrm\Http\Controllers\AllowanceTypeController;

use Noble\Hrm\Http\Controllers\AllowanceController;

use Noble\Hrm\Http\Controllers\DeductionController;

use Noble\Hrm\Http\Controllers\LoanController;

use Noble\Hrm\Http\Controllers\AttendanceController;

use Noble\Hrm\Http\Controllers\ShiftController;

use Noble\Hrm\Http\Controllers\LeaveApplicationController;

use Noble\Hrm\Http\Controllers\LeaveTypeController;

use Noble\Hrm\Http\Controllers\EventController;

use Noble\Hrm\Http\Controllers\EventTypeController;

use Noble\Hrm\Http\Controllers\AnnouncementController;

use Noble\Hrm\Http\Controllers\AnnouncementCategoryController;

use Noble\Hrm\Http\Controllers\AcknowledgmentController;

use Noble\Hrm\Http\Controllers\DocumentController;

use Noble\Hrm\Http\Controllers\DocumentCategoryController;

use Noble\Hrm\Http\Controllers\HolidayController;

use Noble\Hrm\Http\Controllers\HolidayTypeController;

use Noble\Hrm\Http\Controllers\EmployeeTransferController;

use Noble\Hrm\Http\Controllers\ComplaintTypeController;

use Noble\Hrm\Http\Controllers\WarningController;

use Noble\Hrm\Http\Controllers\WarningTypeController;

use Noble\Hrm\Http\Controllers\ViolationTypeController;

use Noble\Hrm\Http\Controllers\OnboardingController;
use Noble\Hrm\Http\Controllers\CompanyAssetController;
use Noble\Hrm\Http\Controllers\VacationSettlementController;
use Noble\Hrm\Http\Controllers\FinalSettlementController;
use Noble\Hrm\Http\Controllers\ComplaintController;

use Noble\Hrm\Http\Controllers\TerminationController;

use Noble\Hrm\Http\Controllers\TerminationTypeController;

use Noble\Hrm\Http\Controllers\ResignationController;

use Noble\Hrm\Http\Controllers\PromotionController;

use Noble\Hrm\Http\Controllers\AwardController;

use Noble\Hrm\Http\Controllers\AwardTypeController;

use Noble\Hrm\Http\Controllers\EmployeeController;

use Noble\Hrm\Http\Controllers\EmployeeDocumentTypeController;

use Noble\Hrm\Http\Controllers\DesignationController;
...
use Noble\Hrm\Http\Controllers\WorkingDaysController;

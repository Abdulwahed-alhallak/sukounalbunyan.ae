...
use Noble\Taskly\Http\Controllers\DashboardController;
use Noble\Taskly\Http\Controllers\ProjectController;
use Noble\Taskly\Http\Controllers\ProjectTaskController;
use Noble\Taskly\Http\Controllers\TaskStageController;
use Noble\Taskly\Http\Controllers\BugStageController;
use Noble\Taskly\Http\Controllers\ProjectBugController;
use Noble\Taskly\Http\Controllers\ProjectReportController;
...
Route::middleware(['web', 'auth', 'verified', 'PlanModuleCheck:Taskly'])->group(function () {
    ...
    // Task Timers
    Route::get('/project/tasks/{task}/timers', [\Noble\Taskly\Http\Controllers\TaskTimerController::class, 'getTimers'])->name('project.tasks.timers.index');
    Route::post('/project/tasks/{task}/timers/start', [\Noble\Taskly\Http\Controllers\TaskTimerController::class, 'start'])->name('project.tasks.timers.start');
    Route::post('/project/tasks/{task}/timers/stop', [\Noble\Taskly\Http\Controllers\TaskTimerController::class, 'stop'])->name('project.tasks.timers.stop');
    ...
    // Project expenses
    Route::post('/project/{project}/expenses', [\Noble\Taskly\Http\Controllers\ProjectExpenseController::class, 'store'])->name('project.expenses.store');
    Route::delete('/project/expenses/{expense}', [\Noble\Taskly\Http\Controllers\ProjectExpenseController::class, 'destroy'])->name('project.expenses.destroy');

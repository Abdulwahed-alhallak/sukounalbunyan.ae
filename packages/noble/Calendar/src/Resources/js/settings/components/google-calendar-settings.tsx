          ...
          {googleCalendarSettings.google_calendar_enable && (
            <>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {!userSettings?.google_calendar_json_file ? (
                        <>
                          <p className="text-sm text-destructive dark:text-destructive mb-3">
                        ...
                        <div className="p-3 bg-muted/50 dark:bg-foreground/20 border border-border dark:border-foreground rounded-lg">
                ...
                <div className="lg:col-span-1 border rounded-lg p-4 bg-muted/50 dark:bg-foreground/20">
                  <h4 className="font-medium mb-3 text-foreground dark:text-foreground">

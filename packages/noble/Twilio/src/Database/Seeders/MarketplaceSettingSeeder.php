...
namespace Noble\Twilio\Database\Seeders;
        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/noble/Twilio/src/marketplace/' . $file->getFilename();
                }
            }
        }
                    ...
                    'dedication'  => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'screenshot'  => '/packages/noble/Twilio/src/marketplace/image1.png'
                            ],
                            [
                                ...
                                'screenshot'  => '/packages/noble/Twilio/src/marketplace/image2.png'
                            ],
                            [
                                ...
                                'screenshot'  => '/packages/noble/Twilio/src/marketplace/image3.png'
                            ]
                        ]
                    ],
                    'screenshots' => [

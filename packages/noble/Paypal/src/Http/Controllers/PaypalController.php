...
use Noble\Paypal\Events\PaypalPaymentStatus;
use Inertia\Inertia;
use Srmklive\PayPal\Services\PayPal as PayPalClient;
use Noble\Bookings\Models\BookingAppointment;
use Noble\Bookings\Models\BookingPackage;
use Noble\Bookings\Models\BookingCustomer;

use Noble\LMS\Models\LMSCart;
use Noble\LMS\Models\LMSOrder;
use Noble\LMS\Models\LMSOrderItem;
use Noble\LMS\Models\LMSCoupon;
use Illuminate\Support\Facades\Log;
use Noble\BeautySpaManagement\Models\BeautyBooking;
use Noble\BeautySpaManagement\Models\BeautyService;
use Noble\BeautySpaManagement\Models\BeautyBookingReceipt;
use Noble\ParkingManagement\Models\ParkingBooking;
use Noble\Paypal\Events\BeautyBookingPaymentPaypal;
use Noble\Paypal\Events\ParkingBookingPaymentPaypal;
use Noble\Paypal\Events\LaundryBookingPaymentPaypal;
use Noble\EventsManagement\Models\Event;
use Noble\EventsManagement\Models\EventBooking;
use Noble\EventsManagement\Models\EventBookingPayment;
    ...
    public function laundryGetPaypalStatus(Request $request)
    {
        ...
        try {
            if ($request->return_type == 'success' && $request->token) {
                ...
                if (isset($response['status']) && $response['status'] == 'COMPLETED') {
                    $booking = new \Noble\LaundryManagement\Models\LaundryRequest();
                    $booking->name = $bookingData['name'];
                    $booking->email = $bookingData['email'];

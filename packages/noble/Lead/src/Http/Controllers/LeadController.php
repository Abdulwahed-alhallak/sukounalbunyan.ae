...
use Noble\Lead\Http\Requests\StoreLeadRequest;
use Noble\Lead\Http\Requests\UpdateLeadRequest;
...
use Noble\Lead\Http\Requests\AssignUsersRequest;
use Noble\Lead\Http\Requests\StoreLeadCallRequest;
use Noble\Lead\Http\Requests\UpdateLeadCallRequest;
use Noble\Lead\Models\LeadActivityLog;
...
use Noble\Lead\Http\Requests\ConvertToDealRequest;
use Noble\Lead\Http\Requests\StoreLeadEmailRequest;
use Noble\Lead\Http\Requests\StoreLeadDiscussionRequest;
...
use Noble\Lead\Events\UpdateLead;
use Noble\Lead\Events\DestroyLead;
use Noble\Lead\Events\LeadMoved;
use Noble\Lead\Events\LeadAddUser;
use Noble\Lead\Events\DestroyUserLead;
use Noble\Lead\Events\LeadAddProduct;
use Noble\Lead\Events\DestroyLeadProduct;
use Noble\Lead\Events\LeadUploadFile;
use Noble\Lead\Events\DestroyLeadFile;
use Noble\Lead\Events\LeadSourceUpdate;
use Noble\Lead\Events\DestroyLeadSource;
use Noble\Lead\Events\LeadAddDiscussion;
use Noble\Lead\Events\LeadAddCall;
use Noble\Lead\Events\LeadCallUpdate;
use Noble\Lead\Events\DestroyLeadCall;
use Noble\Lead\Events\LeadAddEmail;
...
class LeadController extends Controller
{
    ...
    public function destroyAttachment($attachmentId)
    {
        if (Auth::user()->can('edit-leads')) {
            $attachment = \Noble\Taskly\Models\TaskAttachment::find($attachmentId);
            if ($attachment) {
                $attachment->delete();

...
use Noble\Lead\Http\Requests\StorePipelineRequest;
use Noble\Lead\Http\Requests\UpdatePipelineRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Lead\Events\CreatePipeline;
use Noble\Lead\Events\UpdatePipeline;
use Noble\Lead\Events\DestroyPipeline;

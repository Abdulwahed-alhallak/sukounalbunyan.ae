...
use Noble\Lead\Http\Requests\StoreDealRequest;
use Noble\Lead\Http\Requests\UpdateDealRequest;
...
use Noble\Lead\Http\Requests\StoreDealCallRequest;
use Noble\Lead\Http\Requests\UpdateDealCallRequest;
use Noble\Lead\Http\Requests\StoreDealEmailRequest;
use Noble\Lead\Http\Requests\StoreDealDiscussionRequest;
use Noble\Lead\Models\ClientPermission;
use Noble\Lead\Models\DealActivityLog;
...
use Noble\Lead\Events\UpdateDeal;
use Noble\Lead\Events\DestroyDeal;
use Noble\Lead\Events\DealMoved;
use Noble\Lead\Events\DealAddUser;
use Noble\Lead\Events\DestroyUserDeal;
use Noble\Lead\Events\DealAddClient;
use Noble\Lead\Events\DestroyDealClient;
use Noble\Lead\Events\DealAddProduct;
use Noble\Lead\Events\DestroyDealProduct;
use Noble\Lead\Events\DealUploadFile;
use Noble\Lead\Events\DestroyDealFile;
use Noble\Lead\Events\DealSourceUpdate;
use Noble\Lead\Events\DestroyDealSource;
use Noble\Lead\Events\DealAddDiscussion;
use Noble\Lead\Events\DealAddCall;
use Noble\Lead\Events\DealCallUpdate;
use Noble\Lead\Events\DestroyDealCall;
use Noble\Lead\Events\DealAddEmail;
        ...
        try {
            if (Auth::user()->can('view-deals')) {
                if ($deal->created_by == creatorId()) {
                    ...
                    $availableSources = \Noble\Lead\Models\Source::where('created_by', creatorId())->get(['id', 'name']);

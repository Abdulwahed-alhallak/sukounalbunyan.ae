...
use Noble\Lead\Http\Requests\StoreLeadStageRequest;
use Noble\Lead\Http\Requests\UpdateLeadStageRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Illuminate\Http\Request;
use Inertia\Inertia;
use Noble\Lead\Models\Pipeline;
use Noble\Lead\Events\CreateLeadStage;
use Noble\Lead\Events\UpdateLeadStage;
use Noble\Lead\Events\DestroyLeadStage;

...
use Noble\Lead\Http\Requests\StoreDealStageRequest;
use Noble\Lead\Http\Requests\UpdateDealStageRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Illuminate\Http\Request;
use Inertia\Inertia;
use Noble\Lead\Models\Pipeline;
use Noble\Lead\Events\CreateDealStage;
use Noble\Lead\Events\UpdateDealStage;
use Noble\Lead\Events\DestroyDealStage;

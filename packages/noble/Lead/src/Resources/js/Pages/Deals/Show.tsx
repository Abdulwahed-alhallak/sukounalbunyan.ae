...
export default function Show() {
    const { deal, availableUsers, availableProducts, availableSources, availableClients } =
        usePage<DealShowProps>().props;
                ...
                return (
                    <General
                        ...
                        onStatusChange={(status) => {
                            ...
                            router.post(
                                route('lead.deals.change-status', deal.id),
                                {
                                    deal_status: status,
                                },
                                {
            ...
            case 'clients':
                return (
                    <Clients
                        ...
                        onRegisterAddHandler={(handler) => setAddHandlers((prev) => ({ ...prev, clients: handler }))}
                        onDealUpdate={setCurrentDeal}
                    />
                );
            default:
        ...
        >
            ...
            <div className="flex flex-col gap-6 md:flex-row">
                <div className="flex-shrink-0 md:w-56">
                    <DealShowSidebar activeItem={activeSection} onSectionChange={setActiveSection} />
                </div>

...
export default function Index() {
    ...
    const updateStageOrder = (newOrder: number[]) => {
        router.post(
            route('lead.deal-stages.update-order'),
            {
                stage_ids: newOrder,
                                      ...
                                      <Tooltip delayDuration={0}>
                                          <TooltipTrigger asChild>
                                              <Button
                                                  variant="ghost"
                                                  size="sm"
                                                  onClick={() => openModal('edit', dealstage)}
            ...
            >
                                                    ...
                                                    <div
                                                        ...
                                                        onDrop={(e) => {
                                                            ...
                                                            const sortedStages = filteredStages.sort(
                                                                (a: DealStage, b: DealStage) => a.order - b.order
                                                            );
                ...
                <Dialog open={modalState.isOpen} onOpenChange={closeModal}>
                    ...
                    {modalState.mode === 'edit' && modalState.data && (
                        <EditDealStage dealstage={modalState.data} onSuccess={closeModal} pipelines={pipelines} />
                    )}
                </Dialog>

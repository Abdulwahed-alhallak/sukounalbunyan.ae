...
namespace Noble\FormBuilder\Database\Seeders;
        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/noble/FormBuilder/src/marketplace/' . $file->getFilename();
                }
            }
        }
        ...
        MarketplaceSetting::firstOrCreate(['module' => 'FormBuilder'], [
            ...
            'config_sections' => [
                'sections' => [
                    'hero' => [
                        'variant' => 'hero1',
                        'title' => 'FormBuilder Module forNobleArchitecture',
                    ...
                    'dedication' => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'screenshot' => '/packages/noble/FormBuilder/src/marketplace/image1.png'
                            ],
                            [
                                'title' => 'Feature 2',
                                'description' => 'Description of second key feature for formbuilder organization.',
                                'keyPoints' => ['Point 1', 'Point 2', 'Point 3', 'Point 4'],
                                'screenshot' => '/packages/noble/FormBuilder/src/marketplace/image2.png'
                            ],
                            [
                                'title' => 'Feature 3',
                                'description' => 'Description of third key feature for formbuilder tracking.',
                                'keyPoints' => ['Point 1', 'Point 2', 'Point 3', 'Point 4'],
                                'screenshot' => '/packages/noble/FormBuilder/src/marketplace/image3.png'
                            ]
                        ]
                    ],
                    'screenshots' => [

...
namespace Noble\FormBuilder\Http\Controllers;
...
use Noble\FormBuilder\Events\UpdateForm;
use Noble\FormBuilder\Events\DestroyForm;
use Noble\FormBuilder\Events\FormConverted;
use Noble\FormBuilder\Http\Requests\StoreFormRequest;
use Noble\FormBuilder\Http\Requests\UpdateFormRequest;
use Noble\FormBuilder\Http\Requests\FormFieldRequest;
use Noble\FormBuilder\Http\Requests\StoreFormConversionRequest;
    ...
    public function getConversionData(Form $form)
    {
        if (Auth::user()->can('manage-formbuilder-conversions')) {
            ...
            return response()->json([
                ...
                'lead_pipelines' => Module_is_active('Lead') && class_exists('\Noble\Lead\Models\Pipeline') ? \Noble\Lead\Models\Pipeline::where('created_by', creatorId())->select('id', 'name')->get() : [],
                'deal_pipelines' => Module_is_active('Lead') && class_exists('\Noble\Lead\Models\DealPipeline') ? \Noble\Lead\Models\DealPipeline::where('created_by', creatorId())->select('id', 'name')->get() : [],
                'clients' => Module_is_active('Lead') && class_exists('\Noble\Lead\Models\User') ? \Noble\Lead\Models\User::where('type', 'client')->where('created_by', creatorId())->select('id', 'name')->get() : [],
                'accounts' => Module_is_active('Sales') && class_exists('\Noble\Sales\Models\Account') ? \Noble\Sales\Models\Account::where('created_by', creatorId())->select('id', 'name')->get() : [],
                'opportunity_stages' => Module_is_active('Sales') && class_exists('\Noble\Sales\Models\OpportunitiesStage') ? \Noble\Sales\Models\OpportunitiesStage::where('created_by', creatorId())->select('id', 'name')->get() : [],
                'contract_types' => Module_is_active('Contract') && class_exists('\Noble\Contract\Models\ContractType') ? \Noble\Contract\Models\ContractType::where('created_by', creatorId())->select('id', 'name')->get() : [],
                'books' => Module_is_active('InternalKnowledge') && class_exists('\Noble\Internalknowledge\Models\Book') ? \Noble\Internalknowledge\Models\Book::where('created_by', creatorId())->select('id', 'title as name')->get() : [],
            ]);
        } else {

...
export default function Responses({ form, responses, auth }: ResponsesProps) {
    ...
    const handleSearch = () => {
        router.get(
            route('formbuilder.forms.responses', form.id),
            {
                search,
                per_page: perPage,
            },
    ...
    return (
        <AuthenticatedLayout
            breadcrumbs={[{ label: t('Form Builder'), url: route('formbuilder.forms.index') }, { label: form.name }]}
            ...
            pageActions={
                <TooltipProvider>
                    <Tooltip>
                        ...
                        <TooltipContent>
                            <p>{copiedLink ? t('Copied!') : t('Copy')}</p>
                        </TooltipContent>
                    </Tooltip>
                </TooltipProvider>
            }
                    ...
                    {responses?.total > 0 && (
                        <div className="flex items-center justify-between px-2 py-4">
                            <div className="text-sm text-muted-foreground">
                                {t('Showing')} {responses.from} {t('to')} {responses.to} {t('of')} {responses.total}{' '}
                                {t('results')}
                            </div>
                    ...
                    {viewResponse && (
                        <>
                            ...
                            <div className="space-y-4">
                                <div>
                                    <Label className="text-sm font-medium text-foreground">{t('Submitted At')}</Label>
                                    <p className="mt-1 text-sm text-foreground">
                                        {formatDateTime(viewResponse.created_at)}
                                    </p>
                                </div>
                                        ...
                                        <div key={index}>
                                            ...
                                            <p className="mt-1 text-sm text-foreground">
                                                {typeof value === 'boolean' ? (
                                                    ...
                                                    <span className="text-muted-foreground">{t('No response')}</span>
                                                )}
                                            </p>
                                        </div>
                                    );

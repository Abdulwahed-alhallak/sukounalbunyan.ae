          ...
          <TooltipProvider>
            <Tooltip >
              <TooltipTrigger asChild>
                <Button variant="ghost" size="sm" onClick={() => setViewResponse(response)} className="h-8 w-8 p-0 text-foreground hover:text-foreground">
            ...
            <>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-foreground">{formatDateTime(viewResponse.created_at)}</p>
                </div>

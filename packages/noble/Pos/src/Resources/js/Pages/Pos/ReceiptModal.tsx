        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
                <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto backdrop-blur-none">
                    ...
                    <div className="space-y-4">
                        {/* Success Message */}
                        <div className="text-center bg-muted/50 p-4 rounded-lg no-print">
                            <p className="text-foreground font-medium">{t('Your transaction has been processed successfully.')}</p>
                            <p className="text-foreground text-sm mt-1">{t('Receipt Number')}: {completedSale.pos_number}</p>
                        </div>

                        {/* Thermal Receipt Preview */}
                        <div ref={receiptRef} className="mx-auto w-72 bg-card border border-border shadow-lg font-mono text-xs leading-tight print-area print-receipt">
                            <div className="p-3">
                                {/* Header */}
                                ...
                                <div className="mb-3">
                                    {completedSale.items?.map((item: any) => {
                                        ...
                                        return (
                                            <div key={item.id} className="mb-3 pb-2 border-b border-dotted border-border">
                                ...
                                <div className="mb-3">
                                    ...
                                    <div className="flex justify-between py-2 text-base font-bold border-t-2 border-double border-border">
                                        <span>{t('Total')}:</span>
                                ...
                                {completedSale.zatca_qr && (
                                    <div className="flex justify-center mt-4 no-print-page-break">
                                        <img src={completedSale.zatca_qr} alt="ZATCA e-Invoice QR" className="w-32 h-32 object-contain" />
                                    </div>
                                )}
                            </div>
                        </div>

...
use Noble\Account\Http\Controllers\RevenueCategoriesController;
use Noble\Account\Http\Controllers\ExpenseCategoriesController;

use Noble\Account\Http\Controllers\ChartOfAccountController;

use Noble\Account\Http\Controllers\BankAccountController;

use Illuminate\Support\Facades\Route;
use Noble\Account\Http\Controllers\AccountTypeController;
use Noble\Account\Http\Controllers\DashboardController;
use Noble\Account\Http\Controllers\SystemSetupController;
use Noble\Account\Http\Controllers\VendorController;
use Noble\Account\Http\Controllers\CustomerController;
use Noble\Account\Http\Controllers\VendorPaymentController;
use Noble\Account\Http\Controllers\BankTransactionController;
use Noble\Account\Http\Controllers\BankTransferController;
use Noble\Account\Http\Controllers\DebitNoteController;
use Noble\Account\Http\Controllers\CreditNoteController;
use Noble\Account\Http\Controllers\CustomerPaymentController;
use Noble\Account\Http\Controllers\RevenueController;
use Noble\Account\Http\Controllers\ExpenseController;
use Noble\Account\Http\Controllers\ReportsController;

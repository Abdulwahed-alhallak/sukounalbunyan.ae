        ...
        >
            ...
            <Card className="shadow-sm mb-4">
                <CardContent className="p-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mt-6 p-4 bg-muted/50 rounded-lg">
                        <div>
                        ...
                        <div>
                            ...
                            <p className="text-lg font-semibold text-foreground">{formatCurrency(vendorData.summary.balance)}</p>
                        </div>
                    </div>
                </CardContent>
            </Card>
                                        ...
                                        {vendorData.invoices?.map((invoice: any, idx: number) => (
                                            <tr key={idx} className="border-t hover:bg-muted/50">
                                                ...
                                                <td className="px-4 py-3">
                                                    <span className="px-2 py-1 text-xs rounded-full bg-muted text-foreground capitalize">
                                                        {invoice.status}
                                                    </span>
                                                </td>
                                    ...
                                    <tbody>
                                        {vendorData.payments?.map((payment: any, idx: number) => (
                                            <tr key={idx} className="border-t hover:bg-muted/50">
                                                ...
                                                <td className="px-4 py-3 text-sm text-muted-foreground">{payment.bank_account || '-'}</td>
                                                <td className="px-4 py-3 text-sm text-muted-foreground">{payment.reference_number || '-'}</td>
                                                <td className="px-4 py-3">
                                                    <span className="px-2 py-1 text-xs rounded-full bg-muted text-foreground capitalize">
                                                        {payment.status}
                                                    </span>

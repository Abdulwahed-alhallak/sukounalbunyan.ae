...
export default function CustomerDetail() {
    ...
    const handleFilter = () => {
        router.get(
            route('account.reports.customer-detail', customerData.customer.id),
            {
        ...
        >
            ...
            <Card className="mb-4 shadow-sm">
                <CardContent className="p-6">
                        ...
                        <div className="flex items-end gap-2">
                            ...
                            {auth.user?.permissions?.includes('print-customer-detail-report') && (
                                <Button
                                    ...
                                    onClick={() =>
                                        window.open(
                                            route('account.reports.customer-detail.print', customerData.customer.id) +
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-4 rounded-lg bg-muted/50 p-4 md:grid-cols-5">
                        ...
                        <div>
                            <p className="text-sm text-muted-foreground">{t('Total Credit Notes')}</p>
                            <p className="text-lg font-semibold">
            ...
            <div className="grid grid-cols-1 gap-4">
                <Card className="shadow-sm">
                    <CardContent className="p-0">
                        <div className="border-b bg-muted/50 p-4">
                            <h3 className="text-lg font-semibold">{t('Sales Invoices')}</h3>
                        </div>
                        {customerData.invoices.length > 0 ? (
                            ...
                            <NoRecordsFound
                                icon={FileText}
                                title={t('No Invoices')}
                                description={t('No sales invoices found')}
                ...
                <Card className="shadow-sm">
                    <CardContent className="p-0">
                        <div className="border-b bg-muted/50 p-4">
                            <h3 className="text-lg font-semibold">{t('Sales Returns')}</h3>
                        </div>
                        {customerData.returns.length > 0 ? (
                            ...
                            <NoRecordsFound
                                icon={FileText}
                                title={t('No Returns')}
                                description={t('No sales returns found')}
                                className="h-auto py-8"
                            />
                        )}
                    </CardContent>
                ...
                <Card className="shadow-sm">
                    <CardContent className="p-0">
                        <div className="border-b bg-muted/50 p-4">
                            <h3 className="text-lg font-semibold">{t('Credit Notes')}</h3>
                        </div>
                        {customerData.credit_notes.length > 0 ? (
                            ...
                            <NoRecordsFound
                                ...
                                description={t('No credit notes found')}
                                className="h-auto py-8"
                            />
                        )}
                    </CardContent>
                ...
                <Card className="shadow-sm">
                    <CardContent className="p-0">
                        <div className="border-b bg-muted/50 p-4">
                            <h3 className="text-lg font-semibold">{t('Customer Payments')}</h3>
                        </div>
                        {customerData.payments.length > 0 ? (
                            ...
                            <NoRecordsFound
                                icon={FileText}
                                title={t('No Payments')}
                                description={t('No customer payments found')}
                                className="h-auto py-8"
                            />
                        )}
                    </CardContent>

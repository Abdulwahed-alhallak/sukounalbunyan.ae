                    ...
                    <tbody>
                        {data.vendors?.map((vendor: any, idx: number) => (
                            <tr key={idx} className="border-b border-border">
                                ...
                                <td className="px-2 py-2 text-right text-sm">{formatCurrency(vendor.current)}</td>
                                <td className="px-2 py-2 text-right text-sm">{formatCurrency(vendor['1_30_days'])}</td>
                                <td className="px-2 py-2 text-right text-sm">{formatCurrency(vendor['31_60_days'])}</td>
                                <td className="px-2 py-2 text-right text-sm">{formatCurrency(vendor['61_90_days'])}</td>
                                <td className="px-2 py-2 text-right text-sm">{formatCurrency(vendor.over_90_days)}</td>

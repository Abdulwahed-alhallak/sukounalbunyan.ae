                ...
                <div className="border-b-2 border-border pb-6 mb-8">
                    <div className="flex justify-between items-start">
                        ...
                        <div className="text-right">
                            <h2 className="text-2xl font-bold text-foreground mb-3">{t('CUSTOMER DETAIL REPORT')}</h2>
                            <p className="text-sm text-muted-foreground">{t('Customer')}: {data.customer.name}</p>
                            {filters.start_date && <p className="text-sm text-muted-foreground">{t('Period')}: {formatDate(filters.start_date)} - {formatDate(filters.end_date)}</p>}
                        </div>
                    </div>
                </div>

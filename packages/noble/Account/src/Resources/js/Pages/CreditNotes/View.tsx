                        ...
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <div className="flex items-center gap-4">
                                <span className={`px-2 py-1 rounded-full text-sm ${
                                    creditNote.status === 'approved' ? 'bg-muted text-foreground' :
                                    creditNote.status === 'partial' ? 'bg-muted text-foreground' :
                                    creditNote.status === 'applied' ? 'bg-muted text-foreground' :
                            ...
                            <div>
                                ...
                                <div className="mt-4 p-3 bg-muted/50 rounded">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <div className="text-right">
                                            <div className="text-xl font-bold text-foreground">{formatCurrency(parseFloat(creditNote.balance_amount.toString()))}</div>
                            ...
                            <div className="w-80 space-y-3">
                                ...
                                {creditNote.discount_amount > 0 && (
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="font-medium text-destructive">-{formatCurrency(parseFloat(creditNote.discount_amount.toString()))}</span>
                                    </div>
                                )}
                                ...
                                <div className="border-t pt-3">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-bold text-lg text-foreground">{formatCurrency(parseFloat(creditNote.balance_amount.toString()))}</span>
                                    </div>
                                </div>
                            </div>
                        </div>

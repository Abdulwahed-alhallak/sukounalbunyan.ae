            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <Card className="bg-gradient-to-r from-muted/50 to-muted border-border">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium text-foreground">{t('Total Payments Made')}</CardTitle>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-foreground opacity-80 mt-1">{t('Total amount received')}</p>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-gradient-to-r from-muted/50 to-muted border-border">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold text-destructive">{formatCurrency(stats.total_expenses)}</div>
                        <p className="text-xs text-destructive opacity-80 mt-1">{t('Total expenses')}</p>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-gradient-to-r from-muted/50 to-muted border-border">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-foreground opacity-80 mt-1">{t('Total transactions')}</p>
                    </CardContent>
                </Card>
            </div>

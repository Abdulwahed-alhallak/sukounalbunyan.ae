...
export default function Index() {
    ...
    const tableColumns = [
        ...
        ...(auth.user?.permissions?.some((p: string) =>
            ['edit-revenue-categories', 'delete-revenue-categories'].includes(p)
        )
            ? [
                  {
                      key: 'actions',
                                      ...
                                      <Tooltip delayDuration={0}>
                                          <TooltipTrigger asChild>
                                              <Button
                                                  variant="ghost"
                                                  size="sm"
                                                  onClick={() => openModal('edit', revenuecategories)}
                                        ...
                                        <DataTable
                                            ...
                                            emptyState={
                                                <NoRecordsFound
                                                    ...
                                                    description={t(
                                                        'Get started by creating your first Revenue Categories.'
                                                    )}

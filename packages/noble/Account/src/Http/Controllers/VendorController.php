...
use Noble\Account\Http\Requests\StoreVendorRequest;
use Noble\Account\Http\Requests\UpdateVendorRequest;
use Noble\Account\Events\CreateVendor;
use Noble\Account\Events\UpdateVendor;
use Noble\Account\Events\DestroyVendor;

...
namespace Noble\Account\Http\Controllers;

use Noble\Account\Models\VendorPayment;
use Noble\Account\Models\VendorPaymentAllocation;
use Noble\Account\Models\BankAccount;
use Noble\Account\Models\DebitNote;
use Noble\Account\Models\DebitNoteApplication;
use Noble\Account\Http\Requests\StoreVendorPaymentRequest;
...
use Inertia\Inertia;
use Noble\Account\Events\CreateVendorPayment;
use Noble\Account\Events\UpdateVendorPaymentStatus;
use Noble\Account\Events\DestroyVendorPayment;
...
class VendorPaymentController extends Controller
{
    ...
    public function getOutstandingInvoices($vendorId)
    {
        ...
        $debitNotes = \Noble\Account\Models\DebitNote::where('vendor_id', $vendorId)
            ->where('balance_amount', '>', 0)

...
use Noble\Account\Http\Requests\StoreCustomerRequest;
use Noble\Account\Http\Requests\UpdateCustomerRequest;
use Noble\Account\Events\CreateCustomer;
use Noble\Account\Events\UpdateCustomer;
use Noble\Account\Events\DestroyCustomer;

...
use Noble\Account\Http\Requests\StoreExpenseCategoriesRequest;
use Noble\Account\Http\Requests\UpdateExpenseCategoriesRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Account\Events\CreateExpenseCategories;
use Noble\Account\Events\DestroyExpenseCategories;
use Noble\Account\Events\UpdateExpenseCategories;

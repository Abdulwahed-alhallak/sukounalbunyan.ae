...
export default function GoogleCaptchaSettings({ userSettings, auth }: GoogleCaptchaSettingsProps) {
    ...
    const saveSettings = () => {
        ...
        router.post(
            route('google-captcha.settings.update'),
            {
                settings: settings,
            },
            {
                    ...
                    <div className="flex items-center justify-between rounded-lg border p-4">
                        ...
                        <Switch
                            ...
                            onCheckedChange={(checked) =>
                                handleSwitchChange('recaptcha_enabled', checked ? 'on' : 'off')
                            }
                            disabled={!canEdit}
                        />
                    </div>
                        ...
                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                            ...
                            <div className="lg:col-span-1">
                                <div className="rounded-lg border bg-muted/30 p-4">
                                    <h4 className="mb-3 font-medium">{t('How to get Google reCAPTCHA keys')}</h4>

                ...
                <div className="p-4 bg-muted/30 rounded-lg border">
                  ...
                  <div className="space-y-2 text-sm text-muted-foreground">
                    <div className="flex items-start gap-2">
                      ...
                      <span>{t('Go to')} <a href="https://www.google.com/recaptcha/admin" target="_blank" rel="noopener noreferrer" className="underline hover:no-underline text-foreground">Google reCAPTCHA Admin Console</a></span>
                    </div>
                    <div className="flex items-start gap-2">

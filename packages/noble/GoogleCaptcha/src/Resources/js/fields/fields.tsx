        ...
        <div key="recaptcha-field" className="space-y-2">
          ...
          {recaptchaVersion === 'v3' && (
            <div className="text-sm text-muted-foreground">
              ...
              <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-foreground hover:underline">
                {t('Privacy Policy') || 'Privacy Policy'}
              </a>{' '}
              {t('and') || 'and'}{' '}
              <a href="https://policies.google.com/terms" target="_blank" rel="noopener noreferrer" className="text-foreground hover:underline">

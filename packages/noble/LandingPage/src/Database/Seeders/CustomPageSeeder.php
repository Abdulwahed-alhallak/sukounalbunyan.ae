...
use Noble\LandingPage\Models\CustomPage;
            ...
            [
                ...
                'content' => '<div class="space-y-8">
                    ...
                    <div class="rounded-lg p-8" style="background-color: color-mix(in srgb, var(--color-primary) 5%, white);">
                        <h3 class="text-2xl font-semibold text-gray-900 mb-6 text-center">Why ChooseNobleArchitecture?</h3>
            ...
            [
                ...
                'content' => '<div class="space-y-6">
                    <div>
                        ...
                        <p class="text-gray-600 leading-relaxed">AtNobleArchitecture, we take the security of your business data seriously. This policy outlines how we collect, use, and protect your information.</p>
                    </div>

...
namespace Noble\LandingPage\Database\Seeders;

use Illuminate\Database\Seeder;
use Noble\LandingPage\Models\LandingPageSetting;
        ...
        return [
            ...
            'modules' => [
                ...
                'modules' => [
                    [
                        ...
                        'image' => 'packages/noble/LandingPage/src/Resources/assets/img/hrm.png'
                    ],
                    [
                        'key' => 'account',
                        ...
                        'image' => 'packages/noble/LandingPage/src/Resources/assets/img/accounting.png'
                    ],
                    [
                        'key' => 'taskly',
                        ...
                        'image' => 'packages/noble/LandingPage/src/Resources/assets/img/project.png'
                    ],
                    [
                        'key' => 'crm',
                        'label' => 'CRM & Sales',
                        ...
                        'image' => 'packages/noble/LandingPage/src/Resources/assets/img/crm.png'
                    ],
                    [
                        'key' => 'pos',
                        'label' => 'Point of Sale',
                        ...
                        'image' => 'packages/noble/LandingPage/src/Resources/assets/img/pos.png'
                    ]
                ]
            ],
            'benefits' => [
                'variant' => 'benefits1',
                'title' => 'Why ChooseNobleArchitecture?',
                'benefits' => [
            ...
            'gallery' => [
                ...
                'images' => [
                    ...
                    'packages/noble/LandingPage/src/Resources/assets/img/gallery4.jpeg',
                    'packages/noble/LandingPage/src/Resources/assets/img/gallery5.jpeg',
                    'packages/noble/LandingPage/src/Resources/assets/img/gallery6.jpeg',
                    'packages/noble/LandingPage/src/Resources/assets/img/gallery7.jpeg'
                ]
            ],
            'cta' => [
                'variant' => 'cta1',
                'title' => 'Ready to Transform Your Business?',
                'subtitle' => 'Join thousands of businesses already usingNobleArchitecture to streamline their operations.',

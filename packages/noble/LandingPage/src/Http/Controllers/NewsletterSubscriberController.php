...
namespace Noble\LandingPage\Http\Controllers;

use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use Inertia\Inertia;
use Noble\LandingPage\Models\NewsletterSubscriber;
use Noble\LandingPage\Http\Requests\StoreNewsletterSubscriberRequest;
use Noble\LandingPage\Events\CreateNewsletterSubscriber;
use Noble\LandingPage\Events\DestroyNewsletterSubscriber;

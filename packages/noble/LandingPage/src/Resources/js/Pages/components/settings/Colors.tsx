                            ...
                            return (
                                <button
                                    ...
                                    className={`p-3 border-2 rounded-xl hover:shadow-lg transition-all transform hover:scale-105 ${
                                        isActive ? 'border-foreground shadow-lg ring-2 ring-border' : 'border-border hover:border-border'
                                    }`}
                                    title={preset.name}
                                >
                                    ...
                                    {isActive && (
                                        <div className="w-2 h-2 bg-muted/500 rounded-full mx-auto mt-1"></div>
                                    )}
                                </button>
                            );
                        })}

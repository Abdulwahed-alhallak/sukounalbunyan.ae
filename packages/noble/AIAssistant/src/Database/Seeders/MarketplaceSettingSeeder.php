        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/noble/AIAssistant/src/marketplace/' . $file->getFilename();
                }
            }
        }
        ...
        MarketplaceSetting::firstOrCreate(['module' => 'AIAssistant'], [
            ...
            'config_sections' => [
                'sections'           => [
                    'hero'        => [
                        'variant'               => 'hero1',
                        'title'                 => 'AI Assistant forNobleArchitecture',
                    ...
                    'dedication'  => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'screenshot'  => '/packages/noble/AIAssistant/src/marketplace/image1.png'
                            ],
                            [
                                ...
                                'screenshot'  => '/packages/noble/AIAssistant/src/marketplace/image2.png'
                            ],
                            [
                                ...
                                'screenshot'  => '/packages/noble/AIAssistant/src/marketplace/image3.png'
                            ]
                        ]
                    ],
                    'screenshots' => [

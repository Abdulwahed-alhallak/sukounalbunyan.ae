...
export default function ZoomMeetingSettings({ userSettings = {}, auth }: ZoomMeetingSettingsProps) {
    ...
    const saveSettings = () => {
        ...
        router.post(
            route('zoom-meeting.settings.update'),
            {
                settings: {
                    ...settings,
                    ...
                    {settings.zoom_enabled && (
                        <>
                            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                                ...
                                <div className="bg-muted/50/50 rounded-lg border border-border p-4">
                                    <h4 className="mb-2 font-medium text-foreground">{t('Setup Instructions')}</h4>
                                    <div className="space-y-2 text-sm text-foreground">
                                        <p>
                                            ...
                                            {t('and create a Server-to-Server OAuth app')}
                                        </p>
                                        <p>
                                            {t(
                                                '2. In App Credentials, copy the Account ID, Client ID, and Client Secret'
                                            )}
                                        </p>

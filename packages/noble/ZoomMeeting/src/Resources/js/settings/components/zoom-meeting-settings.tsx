          ...
          {settings.zoom_enabled && (
            <>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="border rounded-lg p-4 bg-muted/50/50 border-border">
                  <h4 className="font-medium mb-2 text-foreground">{t('Setup Instructions')}</h4>
                  <div className="space-y-2 text-sm text-foreground">
                    <p>{t('1. Go to')} <a href="https://marketplace.zoom.us/develop/create" target="_blank" rel="noopener noreferrer" className="text-foreground underline hover:text-foreground">{t('Zoom Marketplace')}</a> {t('and create a Server-to-Server OAuth app')}</p>

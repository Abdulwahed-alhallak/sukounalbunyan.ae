...
namespace Noble\Slack\Database\Seeders;
        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/noble/Slack/src/marketplace/' . $file->getFilename();
                }
            }
        }
                    ...
                    'dedication' => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'screenshot' => '/packages/noble/Slack/src/marketplace/image1.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/noble/Slack/src/marketplace/image2.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/noble/Slack/src/marketplace/image3.png'
                            ]
                        ]
                    ],
                    'screenshots' => [

...
use Noble\Recruitment\Http\Requests\StoreJobTypeRequest;
use Noble\Recruitment\Http\Requests\UpdateJobTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Noble\Recruitment\Events\CreateJobType;
use Noble\Recruitment\Events\UpdateJobType;
use Noble\Recruitment\Events\DestroyJobType;

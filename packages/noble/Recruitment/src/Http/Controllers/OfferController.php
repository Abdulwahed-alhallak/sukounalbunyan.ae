...
use Noble\Recruitment\Http\Requests\StoreOfferRequest;
use Noble\Recruitment\Http\Requests\UpdateOfferRequest;
...
use Noble\Recruitment\Http\Requests\ConvertToEmployeeRequest;
...
use Noble\Recruitment\Events\CreateOffer;
use Noble\Recruitment\Events\UpdateOffer;
use Noble\Recruitment\Events\DestroyOffer;
use Noble\Recruitment\Events\UpdateOfferApprovalStatus;
    ...
    public function index()
    {
        if (Auth::user()->can('manage-offers')) {
            ...
            return Inertia::render('Recruitment/Offers/Index', [
                ...
                'departments' => \Noble\Hrm\Models\Department::where('created_by', creatorId())->select('id', 'department_name as name')->get(),
            ]);
        } else {

...
use Inertia\Inertia;
use Noble\Recruitment\Models\RecruitmentSetting;
use Noble\Recruitment\Models\OfferLetter;
use Noble\Recruitment\Events\UpdateBrandSetting;
use Noble\Recruitment\Events\UpdateAboutCompany;
use Noble\Recruitment\Events\UpdateApplicationTips;
use Noble\Recruitment\Events\UpdateWhatHappensNext;
use Noble\Recruitment\Http\Requests\StoreDashboardWelcomeCardRequest;
use Noble\Recruitment\Events\UpdateNeedHelp;
use Noble\Recruitment\Events\UpdateTrackingFaq;
use Noble\Recruitment\Events\UpdateOfferLetterTemplate;
    ...
    public function index()
    {
        if (Auth::user()->can('manage-recruitment-brand-settings')) {
            ...
            return Inertia::render('Recruitment/SystemSetup/BrandSettings/Index', [
                'settings' => [
                    'logo_dark' => $settings['logo_dark'] ?? 'packages/noble/Recruitment/src/Resources/images/logo.png',

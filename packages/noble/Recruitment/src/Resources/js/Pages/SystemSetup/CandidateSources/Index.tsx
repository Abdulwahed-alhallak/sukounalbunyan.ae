...
export default function Index() {
    ...
    const tableColumns = [
        ...
        ...(auth.user?.permissions?.some((p: string) =>
            ['edit-candidate-sources', 'delete-candidate-sources'].includes(p)
        )
            ? [
                  {
                      key: 'actions',
                                      ...
                                      <Tooltip delayDuration={0}>
                                          <TooltipTrigger asChild>
                                              <Button
                                                  variant="ghost"
                                                  size="sm"
                                                  onClick={() => openModal('edit', candidatesources)}
            ...
            >
                                        ...
                                        <DataTable
                                            ...
                                            emptyState={
                                                <NoRecordsFound
                                                    ...
                                                    description={t(
                                                        'Get started by creating your first Candidate Sources.'
                                                    )}
                ...
                <Dialog open={modalState.isOpen} onOpenChange={closeModal}>
                    ...
                    {modalState.mode === 'edit' && modalState.data && (
                        <EditCandidateSources candidatesources={modalState.data} onSuccess={closeModal} />
                    )}
                </Dialog>

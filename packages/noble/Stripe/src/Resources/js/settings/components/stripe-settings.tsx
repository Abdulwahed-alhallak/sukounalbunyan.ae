                                ...
                                <div className="rounded-lg border bg-muted/50 p-4 dark:bg-foreground/20 lg:col-span-1">
                                    ...
                                    <div className="space-y-2 text-sm text-foreground dark:text-muted-foreground">
                                        <div className="flex items-start gap-2">
                                            <span className="min-w-[20px] font-medium">{t('1.')} </span>
                                            <span>
                                                {t('Go to')}{' '}
                                                <a
                                        ...
                                        <div className="flex items-start gap-2">
                                            <span className="min-w-[20px] font-medium">{t('2.')} </span>
                                            <span>{t('Sign in to your Stripe account or create a new one')}</span>
                                        </div>
                                        <div className="flex items-start gap-2">
                                            <span className="min-w-[20px] font-medium">{t('3.')} </span>
                                            <span>{t('Navigate to Developers → API keys')}</span>
                                        </div>
                                        <div className="flex items-start gap-2">
                                            <span className="min-w-[20px] font-medium">{t('4.')} </span>
                                            <span>{t('Copy the "Publishable key" to the first field above')}</span>
                                        </div>
                                        <div className="flex items-start gap-2">
                                            <span className="min-w-[20px] font-medium">{t('5.')} </span>
                                            <span>
                                                {t('Reveal and copy the "Secret key" to the second field above')}
                                            </span>
                                        </div>
                                        <div className="flex items-start gap-2">
                                            <span className="min-w-[20px] font-medium">{t('6.')} </span>
                                            <span>
                                                {t('Use test keys for development and live keys for production')}
                                            </span>
                                        </div>
                                    </div>
                                </div>

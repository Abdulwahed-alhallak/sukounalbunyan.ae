                    ...
                    {showFilters && (
                        <CardContent className="p-6 bg-muted/50/30 border-b">
                            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-foreground mb-2">{t('Measurement Unit')}</label>
                                    <Input
                                        ...
                                        {indicators.data?.map((indicator) => (
                                            <Card key={indicator.id} className="p-0 hover:shadow-lg transition-all duration-200 flex flex-col h-full min-w-0">
                                                ...
                                                <div className="flex justify-between items-center gap-2 p-3 border-t bg-muted/50/50 flex-shrink-0 mt-auto">
                                                    <span className={`px-2 py-1 rounded-full text-sm ${
                                                        indicator.status === 'active' ? 'bg-muted text-foreground' : 'bg-muted text-destructive'
                                                    }`}>

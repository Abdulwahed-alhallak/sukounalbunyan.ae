                                        ...
                                        {reviewCycles.data?.map((cycle: ReviewCycle) => (
                                            <Card key={cycle.id} className="p-0 hover:shadow-lg transition-all duration-200 flex flex-col h-full min-w-0">
                                                ...
                                                <div className="p-4 border-b flex-shrink-0">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="min-w-0 flex-1">
                                                            <h3 className="font-semibold text-sm text-foreground">{cycle.name}</h3>
                                                            <p className="text-xs text-muted-foreground truncate">{getFrequencyLabel(cycle.frequency)}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex justify-between items-center gap-2 p-3 border-t bg-muted/50/50 flex-shrink-0 mt-auto">
                                                    <span className={`px-2 py-1 rounded-full text-sm ${
                                                        cycle.status === 'active' ? 'bg-muted text-foreground' : 'bg-muted text-destructive'
                                                    }`}>

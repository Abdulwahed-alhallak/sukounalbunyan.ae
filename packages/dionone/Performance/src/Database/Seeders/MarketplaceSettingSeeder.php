...
namespace DionONE\Performance\Database\Seeders;
        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/dionone/Performance/src/marketplace/' . $file->getFilename();
                }
            }
        }
        ...
        MarketplaceSetting::firstOrCreate(['module' => 'Performance'], [
            ...
            'config_sections' => [
                'sections'           => [
                    'hero'        => [
                        'variant'               => 'hero1',
                        'title'                 => 'Performance Management System for DionCreative',
                    ...
                    'dedication'  => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'screenshot'  => '/packages/dionone/Performance/src/marketplace/image1.png'
                            ],
                            [
                                ...
                                'screenshot'  => '/packages/dionone/Performance/src/marketplace/image2.png'
                            ],
                            [
                                ...
                                'screenshot'  => '/packages/dionone/Performance/src/marketplace/image3.png'
                            ]
                        ]
                    ],
                    'screenshots' => [

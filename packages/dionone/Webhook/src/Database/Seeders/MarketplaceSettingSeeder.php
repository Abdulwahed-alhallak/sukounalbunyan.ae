...
namespace DionONE\Webhook\Database\Seeders;

use Illuminate\Database\Seeder;
use DionONE\LandingPage\Models\MarketplaceSetting;
        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/dionone/Webhook/src/marketplace/' . $file->getFilename();
                }
            }
        }
        ...
        MarketplaceSetting::firstOrCreate(['module' => 'Webhook'], [
            ...
            'config_sections' => [
                'sections' => [
                    'hero' => [
                        'variant' => 'hero1',
                        'title' => 'Webhook Module for DionCreative',
                    ...
                    'dedication' => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'description' => 'Automatically send HTTP requests to external systems when events occur across 30+ modules in your DionONE system. This powerful integration ensures your external applications stay synchronized with real-time data updates.',
                                'keyPoints' => ['Event-driven automation', 'Multi-module support', 'Real-time synchronization', 'External system integration'],
                                'screenshot' => '/packages/dionone/Webhook/src/marketplace/image1.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/dionone/Webhook/src/marketplace/image2.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/dionone/Webhook/src/marketplace/image3.png'
                            ]
                        ]
                    ],
                    'screenshots' => [

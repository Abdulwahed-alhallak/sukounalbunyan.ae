...
namespace DionONE\Paypal\Http\Controllers;
...
use DionONE\Paypal\Events\PaypalPaymentStatus;
use Inertia\Inertia;
use Srmklive\PayPal\Services\PayPal as PayPalClient;
use DionONE\Bookings\Models\BookingAppointment;
use DionONE\Bookings\Models\BookingPackage;
use DionONE\Bookings\Models\BookingCustomer;

use DionONE\LMS\Models\LMSCart;
use DionONE\LMS\Models\LMSOrder;
use DionONE\LMS\Models\LMSOrderItem;
use DionONE\LMS\Models\LMSCoupon;
use Illuminate\Support\Facades\Log;
use DionONE\BeautySpaManagement\Models\BeautyBooking;
use DionONE\BeautySpaManagement\Models\BeautyService;
use DionONE\BeautySpaManagement\Models\BeautyBookingReceipt;
use DionONE\ParkingManagement\Models\ParkingBooking;
use DionONE\Paypal\Events\BeautyBookingPaymentPaypal;
use DionONE\Paypal\Events\ParkingBookingPaymentPaypal;
use DionONE\Paypal\Events\LaundryBookingPaymentPaypal;
use DionONE\EventsManagement\Models\Event;
use DionONE\EventsManagement\Models\EventBooking;
use DionONE\EventsManagement\Models\EventBookingPayment;
    ...
    public function laundryGetPaypalStatus(Request $request)
    {
        ...
        try {
            if ($request->return_type == 'success' && $request->token) {
                ...
                if (isset($response['status']) && $response['status'] == 'COMPLETED') {
                    $booking = new \DionONE\LaundryManagement\Models\LaundryRequest();
                    $booking->name = $bookingData['name'];
                    $booking->email = $bookingData['email'];

...
use DionONE\Hrm\Http\Requests\StoreComplaintTypeRequest;
use DionONE\Hrm\Http\Requests\UpdateComplaintTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Hrm\Events\CreateComplaintType;
use DionONE\Hrm\Events\DestroyComplaintType;
use DionONE\Hrm\Events\UpdateComplaintType;

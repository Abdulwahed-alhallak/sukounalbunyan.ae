...
use DionONE\Hrm\Http\Requests\StoreEventRequest;
use DionONE\Hrm\Http\Requests\UpdateEventRequest;
...
use DionONE\Hrm\Events\DestroyEvent;
use DionONE\Hrm\Events\UpdateEvent;

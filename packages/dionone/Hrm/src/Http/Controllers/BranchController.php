...
use DionONE\Hrm\Http\Requests\StoreBranchRequest;
use DionONE\Hrm\Http\Requests\UpdateBranchRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Hrm\Events\CreateBranch;
use DionONE\Hrm\Events\DestroyBranch;
use DionONE\Hrm\Events\UpdateBranch;

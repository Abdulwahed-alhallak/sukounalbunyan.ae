...
use DionONE\Hrm\Http\Requests\StoreWarningTypeRequest;
use DionONE\Hrm\Http\Requests\UpdateWarningTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Hrm\Events\CreateWarningType;
use DionONE\Hrm\Events\DestroyWarningType;
use DionONE\Hrm\Events\UpdateWarningType;

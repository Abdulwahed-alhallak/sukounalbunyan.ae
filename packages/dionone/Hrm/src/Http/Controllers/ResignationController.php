...
use App\Models\User;
use DionONE\Hrm\Models\Resignation;
use DionONE\Hrm\Http\Requests\StoreResignationRequest;
use DionONE\Hrm\Http\Requests\UpdateResignationRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Illuminate\Http\Request;
use Inertia\Inertia;
use DionONE\Hrm\Events\UpdateResignaionStatus;

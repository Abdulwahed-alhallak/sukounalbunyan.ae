...
use DionONE\Hrm\Http\Requests\StoreAllowanceTypeRequest;
use DionONE\Hrm\Http\Requests\UpdateAllowanceTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Hrm\Events\CreateAllowanceType;
use DionONE\Hrm\Events\DestroyAllowanceType;
use DionONE\Hrm\Events\UpdateAllowanceType;

...
use DionONE\Hrm\Http\Requests\StoreLoanRequest;
use DionONE\Hrm\Http\Requests\UpdateLoanRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use DionONE\Hrm\Events\CreateLoan;
use DionONE\Hrm\Events\UpdateLoan;
use DionONE\Hrm\Events\DestroyLoan;

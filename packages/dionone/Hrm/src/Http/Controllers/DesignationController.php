...
use DionONE\Hrm\Http\Requests\StoreDesignationRequest;
use DionONE\Hrm\Http\Requests\UpdateDesignationRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Hrm\Models\Branch;
use DionONE\Hrm\Models\Department;
use DionONE\Hrm\Events\CreateDesignation;
use DionONE\Hrm\Events\DestroyDesignation;
use DionONE\Hrm\Events\UpdateDesignation;

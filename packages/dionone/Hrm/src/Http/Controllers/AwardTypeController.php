...
use DionONE\Hrm\Http\Requests\StoreAwardTypeRequest;
use DionONE\Hrm\Http\Requests\UpdateAwardTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Hrm\Events\CreateAwardType;
use DionONE\Hrm\Events\DestroyAwardType;
use DionONE\Hrm\Events\UpdateAwardType;

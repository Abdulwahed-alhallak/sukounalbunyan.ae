...
use DionONE\Hrm\Http\Requests\StoreAnnouncementRequest;
use DionONE\Hrm\Http\Requests\UpdateAnnouncementRequest;
...
use DionONE\Hrm\Events\DestroyAnnouncement;
use DionONE\Hrm\Events\UpdateAnnouncement;
            ...
            $announcements = Announcement::query()
                ...
                ->where(function ($q) {
                    if (Auth::user()->can('manage-any-announcements')) {
                        ...
                        $employee = \DionONE\Hrm\Models\Employee::where('user_id', Auth::id())->first();

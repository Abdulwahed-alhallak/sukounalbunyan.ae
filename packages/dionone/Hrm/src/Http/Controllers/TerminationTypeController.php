...
use DionONE\Hrm\Http\Requests\StoreTerminationTypeRequest;
use DionONE\Hrm\Http\Requests\UpdateTerminationTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Hrm\Events\CreateTerminationType;
use DionONE\Hrm\Events\DestroyTerminationType;
use DionONE\Hrm\Events\UpdateTerminationType;

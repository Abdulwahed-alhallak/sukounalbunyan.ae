...
use DionONE\Hrm\Http\Requests\StoreHrmDocumentRequest;
use DionONE\Hrm\Http\Requests\UpdateHrmDocumentRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Hrm\Models\DocumentCategory;
use DionONE\Hrm\Events\CreateDocument;
use DionONE\Hrm\Events\DestroyDocument;
use DionONE\Hrm\Events\UpdateDocument;

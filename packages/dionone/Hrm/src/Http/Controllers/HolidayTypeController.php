...
use DionONE\Hrm\Http\Requests\StoreHolidayTypeRequest;
use DionONE\Hrm\Http\Requests\UpdateHolidayTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Hrm\Events\CreateHolidayType;
use DionONE\Hrm\Events\DestroyHolidayType;
use DionONE\Hrm\Events\UpdateHolidayType;

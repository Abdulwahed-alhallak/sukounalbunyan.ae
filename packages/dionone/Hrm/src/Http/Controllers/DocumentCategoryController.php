...
use DionONE\Hrm\Http\Requests\StoreDocumentCategoryRequest;
use DionONE\Hrm\Http\Requests\UpdateDocumentCategoryRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Hrm\Events\CreateDocumentCategory;
use DionONE\Hrm\Events\DestroyDocumentCategory;
use DionONE\Hrm\Events\UpdateDocumentCategory;

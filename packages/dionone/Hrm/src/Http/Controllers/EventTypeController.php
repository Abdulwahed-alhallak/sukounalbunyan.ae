...
use DionONE\Hrm\Http\Requests\StoreEventTypeRequest;
use DionONE\Hrm\Http\Requests\UpdateEventTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Hrm\Events\CreateEventType;
use DionONE\Hrm\Events\DestroyEventType;
use DionONE\Hrm\Events\UpdateEventType;

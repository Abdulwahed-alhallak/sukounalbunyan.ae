...
use DionONE\Hrm\Http\Requests\StoreLeaveTypeRequest;
use DionONE\Hrm\Http\Requests\UpdateLeaveTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Hrm\Events\CreateLeaveType;
use DionONE\Hrm\Events\DestroyLeaveType;
use DionONE\Hrm\Events\UpdateLeaveType;

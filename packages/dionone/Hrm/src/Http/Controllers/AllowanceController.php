...
use DionONE\Hrm\Http\Requests\StoreAllowanceRequest;
use DionONE\Hrm\Http\Requests\UpdateAllowanceRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Illuminate\Http\Request;
use DionONE\Hrm\Events\CreateAllowance;
use DionONE\Hrm\Events\UpdateAllowance;
use DionONE\Hrm\Events\DestroyAllowance;

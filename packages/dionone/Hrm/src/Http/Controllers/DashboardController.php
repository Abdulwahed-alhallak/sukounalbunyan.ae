...
use Inertia\Inertia;
use DionONE\Hrm\Models\HrmItem;
...
class DashboardController extends Controller
{
    ...
    private function companyDashboard(Request $request)
    {
        ...
        return Inertia::render('Hrm/Dashboard/company-dashboard', [
            // Eager-loaded lightweight stats (instant display)
            'stats' => [
            ...
            // Deferred heavy data (loaded in background, shown with skeletons)
            'deferredData' => Inertia::defer(fn () => [

...
use DionONE\Hrm\Http\Requests\StoreDeductionTypeRequest;
use DionONE\Hrm\Http\Requests\UpdateDeductionTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Hrm\Events\CreateDeductionType;
use DionONE\Hrm\Events\DestroyDeductionType;
use DionONE\Hrm\Events\UpdateDeductionType;

                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold ${
                                    leaveapplication.status === 'pending' ? 'bg-muted text-foreground' :
                                    leaveapplication.status === 'approved' ? 'bg-muted text-foreground' :
                                    leaveapplication.status === 'rejected' ? 'bg-muted text-destructive' :

                            ...
                            <TabsContent value="personal" className="space-y-6 mt-6">
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
                                    <div>
                                        ...
                                        <Input id="employee_id" value={data.employee_id} disabled placeholder={t('Employee Id')} />
                                    </div>
                                    <div>
                                        <Label htmlFor="application_id">{t('Application ID')}</Label>
                                        <Input id="application_id" value={data.application_id} onChange={(e: any) => setData('application_id', e.target.value)} placeholder={t('e.g., S-01-2017')} />
                                        <InputError message={errors.application_id} />
                                    </div>
                                    <div>
                                        <Label htmlFor="name_ar">{t('الاسم بالعربي')}</Label>
                                        <Input id="name_ar" value={data.name_ar} onChange={(e: any) => setData('name_ar', e.target.value)} placeholder={t('أدخل الاسم بالعربي')} dir="rtl" />
                                    </div>
                                    <div>
                                        <Label required>{t('Date Of Birth')}</Label>
                                        <DatePicker value={data.date_of_birth} onChange={(date: any) => setData('date_of_birth', date)} placeholder={t('Select Date')} required />
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
                                    <div>
                                        ...
                                        <RadioGroup value={data.gender || 'Male'} onValueChange={(value: any) => setData('gender', value)} className="flex gap-6 mt-2">
                                    ...
                                    <div>
                                        ...
                                        <Input id="nationality" value={data.nationality} onChange={(e: any) => setData('nationality', e.target.value)} placeholder={t('e.g., Saudi, Egyptian')} />
                                    </div>
                                    <div>
                                        <Label htmlFor="marital_status">{t('Marital Status')}</Label>
                                        <Select value={data.marital_status} onValueChange={(v: any) => setData('marital_status', v)}>
                                    ...
                                    <div>
                                        ...
                                        <Input id="marital_status2" value={data.marital_status2} onChange={(e: any) => setData('marital_status2', e.target.value)} placeholder={t('Enter Marital Status 2')} />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
                                    <div>
                                        ...
                                        <Input id="place_of_birth" value={data.place_of_birth} onChange={(e: any) => setData('place_of_birth', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="religion">{t('Religion')}</Label>
                                        <Input id="religion" value={data.religion} onChange={(e: any) => setData('religion', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="no_of_dependents">{t('No. of Dependents')}</Label>
                                        <Input id="no_of_dependents" type="number" min="0" value={data.no_of_dependents} onChange={(e: any) => setData('no_of_dependents', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="blood_type">{t('Blood Type')}</Label>
                                        <Select value={data.blood_type} onValueChange={(v: any) => setData('blood_type', v)}>
                                            <SelectTrigger><SelectValue placeholder={t('Select')} /></SelectTrigger>
                                            <SelectContent>
                                ...
                                <div className="flex justify-end">
                                    <Button type="button" onClick={() => setActiveTab('employment')}>{t('Next')}</Button>
                                </div>
                            </TabsContent>
                            ...
                            <TabsContent value="employment" className="space-y-6 mt-6">
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                    <div>
                                        ...
                                        <Select value={data.shift_id?.toString() || ''} onValueChange={(value: any) => setData('shift_id', value)} required>
                                            <SelectTrigger><SelectValue placeholder={t('Select Shift')} /></SelectTrigger>
                                            <SelectContent searchable={true}>
                                                {shifts?.map((item: any) => (
                                                    <SelectItem key={item.id} value={item.id.toString()}>{item.shift_name}</SelectItem>
                                                ))}
                                            </SelectContent>
                                        </Select>
                                    </div>
                                    <div>
                                        ...
                                        <DatePicker value={data.date_of_joining} onChange={(date: any) => setData('date_of_joining', date)} placeholder={t('Select Date')} required />
                                    </div>
                                    <div>
                                        <Label required>{t('Employment Type')}</Label>
                                        <Select value={data.employment_type} onValueChange={(value: any) => setData('employment_type', value)} required>
                                            <SelectTrigger><SelectValue placeholder={t('Select')} /></SelectTrigger>
                                            <SelectContent>
                                    ...
                                    <div>
                                        ...
                                        <Select value={data.branch_id?.toString() || ''} onValueChange={(value: any) => setData('branch_id', value)} required>
                                            <SelectTrigger><SelectValue placeholder={t('Select Branch')} /></SelectTrigger>
                                            <SelectContent searchable={true}>
                                                {filteredBranches?.map((item: any) => (
                                                    <SelectItem key={item.id} value={item.id.toString()}>{item.branch_name}</SelectItem>
                                                ))}
                                            </SelectContent>
                                        </Select>
                                    </div>
                                    <div>
                                        ...
                                        <Select value={data.department_id?.toString() || ''} onValueChange={(value: any) => setData('department_id', value)} disabled={!data.branch_id} required>
                                            <SelectTrigger><SelectValue placeholder={data.branch_id ? t('Select Department') : t('Select Branch first')} /></SelectTrigger>
                                            <SelectContent searchable={true}>
                                                {filteredDepartments?.map((item: any) => (
                                                    <SelectItem key={item.id} value={item.id.toString()}>{item.department_name}</SelectItem>
                                                ))}
                                            </SelectContent>
                                        </Select>
                                    </div>
                                    <div>
                                        ...
                                        <Select value={data.designation_id?.toString() || ''} onValueChange={(value: any) => setData('designation_id', value)} disabled={!data.department_id} required>
                                            <SelectTrigger><SelectValue placeholder={data.department_id ? t('Select Designation') : t('Select Department first')} /></SelectTrigger>
                                            <SelectContent searchable={true}>
                                                {filteredDesignations?.map((item: any) => (
                                                    <SelectItem key={item.id} value={item.id.toString()}>{item.designation_name}</SelectItem>
                                                ))}
                                            </SelectContent>
                                        </Select>
                                    </div>
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                                    <div>
                                        ...
                                        <Input id="job_title" value={data.job_title} onChange={(e: any) => setData('job_title', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="job_title_ar">{t('المسمى الوظيفي بالعربي')}</Label>
                                        <Input id="job_title_ar" value={data.job_title_ar} onChange={(e: any) => setData('job_title_ar', e.target.value)} dir="rtl" />
                                    </div>
                                    <div>
                                        <Label htmlFor="occupation">{t('Occupation')}</Label>
                                        <Input id="occupation" value={data.occupation} onChange={(e: any) => setData('occupation', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="allocated_area">{t('Allocated Area')}</Label>
                                        <Input id="allocated_area" value={data.allocated_area} onChange={(e: any) => setData('allocated_area', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="line_manager">{t('Line Manager')}</Label>
                                        <Input id="line_manager" value={data.line_manager} onChange={(e: any) => setData('line_manager', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="employer_number">{t('Employer Number')}</Label>
                                        <Input id="employer_number" value={data.employer_number} onChange={(e: any) => setData('employer_number', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label>{t('GOSI Joining Date')}</Label>
                                        <DatePicker value={data.gosi_joining_date} onChange={(date: any) => setData('gosi_joining_date', date)} placeholder={t('Select Date')} />
                                    </div>
                                    <div>
                                        <Label htmlFor="employee_status">{t('Employee Status')}</Label>
                                        <Select value={data.employee_status} onValueChange={(v: any) => setData('employee_status', v)}>
                                            <SelectTrigger><SelectValue placeholder={t('Select')} /></SelectTrigger>
                                            <SelectContent>
                                    ...
                                    <div>
                                        ...
                                        <Input id="list_type" value={data.list_type} onChange={(e: any) => setData('list_type', e.target.value)} />
                                    </div>
                                </div>

                                <div>
                                    <Label htmlFor="notes">{t('Notes')}</Label>
                                    <Input id="notes" value={data.notes} onChange={(e: any) => setData('notes', e.target.value)} placeholder={t('Additional notes...')} />
                                </div>

                                <div className="flex justify-between">
                                    <Button type="button" variant="outline" onClick={() => setActiveTab('personal')}>{t('Previous')}</Button>
                                    <Button type="button" onClick={() => setActiveTab('contact')}>{t('Next')}</Button>
                                </div>
                            </TabsContent>
                            ...
                            <TabsContent value="contact" className="space-y-6 mt-6">
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                    <div>
                                        ...
                                        <Input id="mobile_no" value={data.mobile_no} onChange={(e: any) => setData('mobile_no', e.target.value)} placeholder={t('+966...')} />
                                    </div>
                                    <div>
                                        <Label htmlFor="alternate_mobile_no">{t('Alternate Mobile')}</Label>
                                        <Input id="alternate_mobile_no" value={data.alternate_mobile_no} onChange={(e: any) => setData('alternate_mobile_no', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="email_address">{t('Email Address')}</Label>
                                        <Input id="email_address" type="email" value={data.email_address} onChange={(e: any) => setData('email_address', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="work_email">{t('Work Email')}</Label>
                                        <Input id="work_email" type="email" value={data.work_email} onChange={(e: any) => setData('work_email', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="place_of_residence">{t('Place of Residence')}</Label>
                                        <Input id="place_of_residence" value={data.place_of_residence} onChange={(e: any) => setData('place_of_residence', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="resident_type">{t('Resident Type')}</Label>
                                        <Input id="resident_type" value={data.resident_type} onChange={(e: any) => setData('resident_type', e.target.value)} />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                    <div>
                                        ...
                                        <Input id="address_line_1" value={data.address_line_1} onChange={(e: any) => setData('address_line_1', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="address_line_2">{t('Address Line 2')}</Label>
                                        <Input id="address_line_2" value={data.address_line_2} onChange={(e: any) => setData('address_line_2', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="city">{t('City')}</Label>
                                        <Input id="city" value={data.city} onChange={(e: any) => setData('city', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="state">{t('State')}</Label>
                                        <Input id="state" value={data.state} onChange={(e: any) => setData('state', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="country">{t('Country')}</Label>
                                        <Input id="country" value={data.country} onChange={(e: any) => setData('country', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="postal_code">{t('Postal Code')}</Label>
                                        <Input id="postal_code" value={data.postal_code} onChange={(e: any) => setData('postal_code', e.target.value)} />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                    <div>
                                        ...
                                        <Input id="emergency_contact_name" value={data.emergency_contact_name} onChange={(e: any) => setData('emergency_contact_name', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="emergency_contact_relationship">{t('Relationship')}</Label>
                                        <Input id="emergency_contact_relationship" value={data.emergency_contact_relationship} onChange={(e: any) => setData('emergency_contact_relationship', e.target.value)} />
                                    </div>
                                </div>
                                <div>
                                    <PhoneInputComponent
                                ...
                                <div className="flex justify-between">
                                    <Button type="button" variant="outline" onClick={() => setActiveTab('employment')}>{t('Previous')}</Button>
                                    <Button type="button" onClick={() => setActiveTab('identity')}>{t('Next')}</Button>
                                </div>
                            </TabsContent>
                            ...
                            <TabsContent value="identity" className="space-y-6 mt-6">
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                                    <div>
                                        ...
                                        <Input id="iqama_no" value={data.iqama_no} onChange={(e: any) => setData('iqama_no', e.target.value)} placeholder={t('Enter Iqama Number')} />
                                    </div>
                                    <div>
                                        <Label>{t('Iqama Issue Date')}</Label>
                                        <DatePicker value={data.iqama_issue_date} onChange={(date: any) => setData('iqama_issue_date', date)} placeholder={t('Select Date')} />
                                    </div>
                                    <div>
                                        <Label>{t('Iqama Expiry Date')}</Label>
                                        <DatePicker value={data.iqama_expiry_date} onChange={(date: any) => setData('iqama_expiry_date', date)} placeholder={t('Select Date')} />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                    <div>
                                        ...
                                        <Input id="passport_no" value={data.passport_no} onChange={(e: any) => setData('passport_no', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label>{t('Passport Expiry Date')}</Label>
                                        <DatePicker value={data.passport_expiry_date} onChange={(date: any) => setData('passport_expiry_date', date)} placeholder={t('Select Date')} />
                                    </div>
                                </div>
                                <div className="flex justify-between">
                            ...
                            <TabsContent value="banking" className="space-y-6 mt-6">
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                                    <div>
                                        ...
                                        <Input id="basic_salary" type="number" step="0.01" min="0" value={data.basic_salary} onChange={(e: any) => setData('basic_salary', e.target.value)} placeholder={t('SAR')} />
                                    </div>
                                    <div>
                                        <Label htmlFor="payment_method">{t('Payment Method')}</Label>
                                        <Select value={data.payment_method} onValueChange={(v: any) => setData('payment_method', v)}>
                                            <SelectTrigger><SelectValue placeholder={t('Select')} /></SelectTrigger>
                                            <SelectContent>
                                    ...
                                    <div>
                                        ...
                                        <Input id="hours_per_day" type="number" step="0.5" min="0" max="24" value={data.hours_per_day} onChange={(e: any) => setData('hours_per_day', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="days_per_week">{t('Days Per Week')}</Label>
                                        <Input id="days_per_week" type="number" min="0" max="7" value={data.days_per_week} onChange={(e: any) => setData('days_per_week', e.target.value)} />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                    <div>
                                        ...
                                        <Input id="bank_name" value={data.bank_name} onChange={(e: any) => setData('bank_name', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="bank_iban">{t('Bank IBAN')}</Label>
                                        <Input id="bank_iban" value={data.bank_iban} onChange={(e: any) => setData('bank_iban', e.target.value)} placeholder={t('SA...')} />
                                    </div>
                                    <div>
                                        <Label htmlFor="account_holder_name">{t('Account Holder Name')}</Label>
                                        <Input id="account_holder_name" value={data.account_holder_name} onChange={(e: any) => setData('account_holder_name', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="swift_code">{t('SWIFT Code')}</Label>
                                        <Input id="swift_code" value={data.swift_code} onChange={(e: any) => setData('swift_code', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="account_number">{t('Account Number')}</Label>
                                        <Input id="account_number" value={data.account_number} onChange={(e: any) => setData('account_number', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="tax_payer_id">{t('Tax Payer Id')}</Label>
                                        <Input id="tax_payer_id" value={data.tax_payer_id} onChange={(e: any) => setData('tax_payer_id', e.target.value)} />
                                    </div>
                                </div>
                                <div className="flex justify-between">
                            ...
                            <TabsContent value="insurance" className="space-y-6 mt-6">
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                                    <div>
                                        ...
                                        <Select value={data.insurance_status} onValueChange={(v: any) => setData('insurance_status', v)}>
                                            <SelectTrigger><SelectValue placeholder={t('Select')} /></SelectTrigger>
                                            <SelectContent>
                                                <SelectItem value="Active">{t('Active')}</SelectItem>
                                                <SelectItem value="Inactive">{t('Inactive')}</SelectItem>
                                    ...
                                    <div>
                                        ...
                                        <Select value={data.insurance_class} onValueChange={(v: any) => setData('insurance_class', v)}>
                                            <SelectTrigger><SelectValue placeholder={t('Select')} /></SelectTrigger>
                                            <SelectContent>
                                    ...
                                    <div>
                                        ...
                                        <Input id="sponsor_id" value={data.sponsor_id} onChange={(e: any) => setData('sponsor_id', e.target.value)} />
                                    </div>
                                </div>
                                <div className="flex justify-between">
                            ...
                            <TabsContent value="education" className="space-y-6 mt-6">
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                                    <div>
                                        ...
                                        <Select value={data.education_level} onValueChange={(v: any) => setData('education_level', v)}>
                                            <SelectTrigger><SelectValue placeholder={t('Select')} /></SelectTrigger>
                                            <SelectContent>
                                    ...
                                    <div>
                                        ...
                                        <Input id="university" value={data.university} onChange={(e: any) => setData('university', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="major_field">{t('Major / Field')}</Label>
                                        <Input id="major_field" value={data.major_field} onChange={(e: any) => setData('major_field', e.target.value)} />
                                    </div>
                                </div>
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                                    <div>
                                        <Label htmlFor="graduation_year">{t('Graduation Year')}</Label>
                                        <Input id="graduation_year" value={data.graduation_year} onChange={(e: any) => setData('graduation_year', e.target.value)} placeholder="2020" />
                                    </div>
                                    <div>
                                        <Label htmlFor="total_experience_years">{t('Total Experience (Years)')}</Label>
                                        <Input id="total_experience_years" type="number" min="0" value={data.total_experience_years} onChange={(e: any) => setData('total_experience_years', e.target.value)} />
                                    </div>
                                    <div>
                                        <Label htmlFor="computer_skills">{t('Computer Skills')}</Label>
                                        <Input id="computer_skills" value={data.computer_skills} onChange={(e: any) => setData('computer_skills', e.target.value)} />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                                    <div>
                                        ...
                                        <Select value={data.english_level} onValueChange={(v: any) => setData('english_level', v)}>
                                            <SelectTrigger><SelectValue placeholder={t('Select')} /></SelectTrigger>
                                            <SelectContent>
                                    ...
                                    <div>
                                        ...
                                        <Select value={data.arabic_level} onValueChange={(v: any) => setData('arabic_level', v)}>
                                            <SelectTrigger><SelectValue placeholder={t('Select')} /></SelectTrigger>
                                            <SelectContent>
                                                <SelectItem value="None">{t('None')}</SelectItem>
                                                <SelectItem value="Basic">{t('Basic')}</SelectItem>
                                    ...
                                    <div>
                                        ...
                                        <Input id="other_languages" value={data.other_languages} onChange={(e: any) => setData('other_languages', e.target.value)} placeholder={t('e.g., Urdu, Hindi')} />
                                    </div>
                                </div>
                                <div className="flex justify-between">

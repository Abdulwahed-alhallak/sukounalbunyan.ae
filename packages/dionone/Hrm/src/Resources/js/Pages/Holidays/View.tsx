            ...
            <div className="overflow-y-auto flex-1 p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div className="mt-1">
                            <span className={`px-2 py-1 rounded-full text-sm ${
                                holiday.is_sync_google_calendar ? 'bg-muted text-foreground' : 'bg-muted text-destructive'
                            }`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div className="mt-1">
                            <span className={`px-2 py-1 rounded-full text-sm ${
                                holiday.is_sync_outlook_calendar ? 'bg-muted text-foreground' : 'bg-muted text-destructive'
                            }`}>

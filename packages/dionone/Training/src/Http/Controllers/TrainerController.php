...
use DionONE\Training\Http\Requests\StoreTrainerRequest;
use DionONE\Training\Http\Requests\UpdateTrainerRequest;
use DionONE\Training\Events\CreateTrainer;
use DionONE\Training\Events\UpdateTrainer;
use DionONE\Training\Events\DestroyTrainer;

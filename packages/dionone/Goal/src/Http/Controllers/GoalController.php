...
use DionONE\Goal\Http\Requests\StoreGoalRequest;
use DionONE\Goal\Http\Requests\UpdateGoalRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Goal\Models\Goal;
use DionONE\Goal\Models\GoalCategory;
use DionONE\Goal\Events\CreateGoal;
use DionONE\Goal\Events\UpdateGoal;
use DionONE\Goal\Events\DestroyGoal;

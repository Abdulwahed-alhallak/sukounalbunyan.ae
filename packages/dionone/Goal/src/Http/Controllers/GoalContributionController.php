...
namespace DionONE\Goal\Http\Controllers;

use DionONE\Goal\Http\Requests\StoreContributionRequest;
use DionONE\Goal\Http\Requests\UpdateContributionRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Goal\Models\Goal;
use DionONE\Goal\Models\GoalContribution;
use DionONE\Goal\Events\CreateGoalContribution;
use DionONE\Goal\Events\UpdateGoalContribution;
use DionONE\Goal\Events\DestroyGoalContribution;

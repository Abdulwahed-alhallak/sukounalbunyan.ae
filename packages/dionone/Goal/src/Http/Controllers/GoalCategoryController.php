...
use DionONE\Goal\Http\Requests\StoreCategoryRequest;
use DionONE\Goal\Http\Requests\UpdateCategoryRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Goal\Models\GoalCategory;
use DionONE\Goal\Events\CreateGoalCategory;
use DionONE\Goal\Events\UpdateGoalCategory;
use DionONE\Goal\Events\DestroyGoalCategory;

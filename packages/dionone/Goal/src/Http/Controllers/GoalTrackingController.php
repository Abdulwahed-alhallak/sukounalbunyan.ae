...
use DionONE\Goal\Http\Requests\StoreTrackingRequest;
use DionONE\Goal\Http\Requests\UpdateTrackingRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Goal\Models\Goal;
use DionONE\Goal\Models\GoalTracking;
use DionONE\Goal\Events\CreateGoalTracking;
use DionONE\Goal\Events\UpdateGoalTracking;
use DionONE\Goal\Events\DestroyGoalTracking;

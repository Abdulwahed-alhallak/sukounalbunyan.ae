...
namespace DionONE\LandingPage\Database\Seeders;

use Illuminate\Database\Seeder;
use DionONE\LandingPage\Models\LandingPageSetting;
    ...
    private function getDefaultSections(): array
    {
        return [
            'hero' => [
                ...
                'subtitle' => 'Streamline your entire business lifecycle, from finance to operations, with DionCreative. One platform, infinite possibilities.',
                'primary_button_text' => 'Start Free Trial',
                'primary_button_link' => route('register'),
                'secondary_button_text' => 'Login',
                'secondary_button_link' => route('login'),
                'highlight_text' => 'DionCreative',
                'image' => 'packages/dionone/LandingPage/src/Resources/assets/img/hero.png'
            ],
            'header' => [
                'variant' => 'header1',
                'company_name' => 'DionCreative',
            ...
            'modules' => [
                ...
                'modules' => [
                    [
                        ...
                        'image' => 'packages/dionone/LandingPage/src/Resources/assets/img/hrm.png'
                    ],
                    [
                        'key' => 'account',
                        ...
                        'image' => 'packages/dionone/LandingPage/src/Resources/assets/img/accounting.png'
                    ],
                    [
                        'key' => 'taskly',
                        ...
                        'image' => 'packages/dionone/LandingPage/src/Resources/assets/img/project.png'
                    ],
                    [
                        'key' => 'crm',
                        'label' => 'CRM & Sales',
                        ...
                        'image' => 'packages/dionone/LandingPage/src/Resources/assets/img/crm.png'
                    ],
                    [
                        'key' => 'pos',
                        'label' => 'Point of Sale',
                        ...
                        'image' => 'packages/dionone/LandingPage/src/Resources/assets/img/pos.png'
                    ]
                ]
            ],
            'benefits' => [
                'variant' => 'benefits1',
                'title' => 'Why Choose DionCreative?',
                'benefits' => [
            ...
            'cta' => [
                ...
                'subtitle' => 'Join thousands of businesses already using DionCreative to streamline their operations.',
            ...
            'footer' => [
                ...
                'email' => 'support@dioncreativesaas.com',

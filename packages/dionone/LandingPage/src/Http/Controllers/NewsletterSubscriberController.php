...
namespace DionONE\LandingPage\Http\Controllers;

use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use Inertia\Inertia;
use DionONE\LandingPage\Models\NewsletterSubscriber;
use DionONE\LandingPage\Http\Requests\StoreNewsletterSubscriberRequest;
use DionONE\LandingPage\Events\CreateNewsletterSubscriber;
use DionONE\LandingPage\Events\DestroyNewsletterSubscriber;

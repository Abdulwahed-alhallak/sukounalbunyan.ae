...
export default function MarketplaceNotFound({ landingPageSettings }: MarketplaceNotFoundProps) {
    ...
    return (
        <div className="min-h-screen bg-card" style={{
            ...
            <Head title="Package Not Found - DionCreative Marketplace" />
            ...
            <section className="py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="max-w-md mx-auto">
                        ...
                        <h2 className="text-2xl font-semibold text-foreground mb-4">{t('Package Not Found')}</h2>
                        <p className="text-muted-foreground mb-8">
                            {t("The package you're looking for doesn't exist or has been removed from our marketplace.")}
                        </p>
                        <button
                            onClick={() => window.history.back()}
                            className="inline-flex items-center px-6 py-3 text-background rounded-md font-medium transition-colors"

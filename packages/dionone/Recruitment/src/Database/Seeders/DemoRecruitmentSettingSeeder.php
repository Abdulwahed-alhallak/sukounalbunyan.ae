...
class DemoRecruitmentSettingSeeder extends Seeder
{
    public function run($userId): void
    {
        ...
        $brandSettings = [
            ...
            [
                'key' => 'footer_text',
                'value' => '© ' . date('Y') . ' DionONE Technologies. All rights reserved. Building the future together.',
                'created_by' => $userId,
            ],
        ];
        ...
        $trackingFaq = [
            ...
            [
                ...
                'answer' => 'Contact our HR team at careers@dionone.io with your full name and email address used for the application.'
            ],
            [

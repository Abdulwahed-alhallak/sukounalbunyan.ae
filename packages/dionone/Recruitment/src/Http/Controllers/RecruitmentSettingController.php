...
namespace DionONE\Recruitment\Http\Controllers;

use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Recruitment\Models\RecruitmentSetting;
use DionONE\Recruitment\Models\OfferLetter;
use DionONE\Recruitment\Events\UpdateBrandSetting;
use DionONE\Recruitment\Events\UpdateAboutCompany;
use DionONE\Recruitment\Events\UpdateApplicationTips;
use DionONE\Recruitment\Events\UpdateWhatHappensNext;
use DionONE\Recruitment\Http\Requests\StoreDashboardWelcomeCardRequest;
use DionONE\Recruitment\Events\UpdateNeedHelp;
use DionONE\Recruitment\Events\UpdateTrackingFaq;
use DionONE\Recruitment\Events\UpdateOfferLetterTemplate;
    ...
    public function index()
    {
        if (Auth::user()->can('manage-recruitment-brand-settings')) {
            ...
            return Inertia::render('Recruitment/SystemSetup/BrandSettings/Index', [
                'settings' => [
                    'logo_dark' => $settings['logo_dark'] ?? 'packages/dionone/Recruitment/src/Resources/images/logo.png',
                    'favicon' => $settings['favicon'] ?? 'packages/dionone/Recruitment/src/Resources/images/favicon.png',

...
use DionONE\Recruitment\Http\Requests\StoreOfferRequest;
use DionONE\Recruitment\Http\Requests\UpdateOfferRequest;
...
use DionONE\Recruitment\Http\Requests\ConvertToEmployeeRequest;
...
use DionONE\Recruitment\Models\Job;
use DionONE\Recruitment\Models\OfferLetter;
use DionONE\Recruitment\Events\CreateOffer;
use DionONE\Recruitment\Events\UpdateOffer;
use DionONE\Recruitment\Events\DestroyOffer;
use DionONE\Recruitment\Events\UpdateOfferApprovalStatus;
    ...
    public function index()
    {
        if (Auth::user()->can('manage-offers')) {
            ...
            return Inertia::render('Recruitment/Offers/Index', [
                ...
                'departments' => \DionONE\Hrm\Models\Department::where('created_by', creatorId())->select('id', 'department_name as name')->get(),
            ]);
        } else {

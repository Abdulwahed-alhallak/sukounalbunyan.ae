...
use DionONE\Recruitment\Http\Requests\StoreCandidateSourcesRequest;
use DionONE\Recruitment\Http\Requests\UpdateCandidateSourcesRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Recruitment\Events\CreateCandidateSources;
use DionONE\Recruitment\Events\UpdateCandidateSources;
use DionONE\Recruitment\Events\DestroyCandidateSources;

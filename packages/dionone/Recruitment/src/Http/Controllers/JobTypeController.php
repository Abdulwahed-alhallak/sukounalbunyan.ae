...
use DionONE\Recruitment\Http\Requests\StoreJobTypeRequest;
use DionONE\Recruitment\Http\Requests\UpdateJobTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Recruitment\Events\CreateJobType;
use DionONE\Recruitment\Events\UpdateJobType;
use DionONE\Recruitment\Events\DestroyJobType;

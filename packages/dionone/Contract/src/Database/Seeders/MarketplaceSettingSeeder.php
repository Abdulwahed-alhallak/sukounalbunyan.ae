...
namespace DionONE\Contract\Database\Seeders;
        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/dionone/Contract/src/marketplace/' . $file->getFilename();
                }
            }
        }
        ...
        MarketplaceSetting::firstOrCreate(['module' => 'Contract'], [
            ...
            'config_sections' => [
                'sections' => [
                    'hero' => [
                        'variant' => 'hero1',
                        'title' => 'Contract Module for DionCreative',
                    ...
                    'dedication' => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'screenshot' => '/packages/dionone/Contract/src/marketplace/image1.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/dionone/Contract/src/marketplace/image2.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/dionone/Contract/src/marketplace/image3.png'
                            ],

...
use DionONE\Account\Http\Requests\StoreBankTransferRequest;
use DionONE\Account\Http\Requests\UpdateBankTransferRequest;
use DionONE\Account\Events\CreateBankTransfer;
use DionONE\Account\Events\UpdateBankTransfer;
use DionONE\Account\Events\DestroyBankTransfer;
use DionONE\Account\Events\ProcessBankTransfer;

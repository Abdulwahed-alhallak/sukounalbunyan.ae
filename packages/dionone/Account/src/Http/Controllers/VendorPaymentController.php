...
namespace DionONE\Account\Http\Controllers;

use DionONE\Account\Models\VendorPayment;
use DionONE\Account\Models\VendorPaymentAllocation;
use DionONE\Account\Models\BankAccount;
use DionONE\Account\Models\DebitNote;
use DionONE\Account\Models\DebitNoteApplication;
use DionONE\Account\Http\Requests\StoreVendorPaymentRequest;
...
use Inertia\Inertia;
use DionONE\Account\Events\CreateVendorPayment;
use DionONE\Account\Events\UpdateVendorPaymentStatus;
use DionONE\Account\Events\DestroyVendorPayment;
...
class VendorPaymentController extends Controller
{
    ...
    public function getOutstandingInvoices($vendorId)
    {
        ...
        $debitNotes = \DionONE\Account\Models\DebitNote::where('vendor_id', $vendorId)
            ->where('balance_amount', '>', 0)

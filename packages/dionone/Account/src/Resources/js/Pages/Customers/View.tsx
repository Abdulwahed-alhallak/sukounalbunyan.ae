            ...
            <div className="overflow-y-auto flex-1 p-4 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{customer.customer_code}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Company Name')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{customer.company_name}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Contact Person Name')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{customer.contact_person_name || '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Contact Person Email')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{customer.contact_person_email || '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Contact Person Mobile')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{customer.contact_person_mobile || '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Tax Number')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{customer.tax_number || '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Payment Terms')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{customer.payment_terms || '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('User')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{customer.user?.name || '-'}</p>
                    </div>
                </div>
                ...
                {customer.notes && (
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{customer.notes}</p>
                    </div>
                )}
            </div>
        </DialogContent>

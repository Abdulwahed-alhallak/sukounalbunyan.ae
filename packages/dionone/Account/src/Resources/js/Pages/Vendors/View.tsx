            ...
            <div className="overflow-y-auto flex-1 p-4 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{vendor.vendor_code}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Company Name')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{vendor.company_name}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Contact Person Name')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{vendor.contact_person_name || '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Contact Person Email')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{vendor.contact_person_email || '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Contact Person Mobile')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{vendor.contact_person_mobile || '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Primary Email')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{vendor.primary_email || '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Primary Mobile')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{vendor.primary_mobile || '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Tax Number')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{vendor.tax_number || '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Payment Terms')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{vendor.payment_terms || '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Currency Code')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{vendor.currency_code || '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Credit Limit')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{vendor.credit_limit ? `$${Number(vendor.credit_limit).toFixed(2)}` : '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('User')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{vendor.user?.name || '-'}</p>
                    </div>
                </div>
                ...
                {vendor.notes && (
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{vendor.notes}</p>
                    </div>
                )}
            </div>
        </DialogContent>

                ...
                {showFilters && (
                    <CardContent className="p-6 bg-muted/50/30 border-b">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-foreground mb-2">{t('Transaction Type')}</label>
                            ...
                            {transactions?.data?.length > 0 ? (
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4">
                                    {transactions?.data?.map((transaction) => (
                                        <Card key={transaction.id} className="border border-border flex flex-col">
                                            <div className="p-4 flex-1">
                                                <div className="flex items-center gap-3 mb-3">
                                                    ...
                                                    <div className="flex-1">
                                                        <h3 className="font-semibold text-base text-foreground">{transaction.reference_number}</h3>
                                                    </div>
                                                </div>

                                                <div className="space-y-3">
                                                    <div>
                                                        <p className="text-xs font-medium text-muted-foreground mb-2">{t('Bank Account')}</p>
                                                        <p className="text-xs text-foreground truncate">{transaction.bank_account.account_name} ({transaction.bank_account.account_number})</p>
                                                    </div>
                                                    ...
                                                    <div className="flex justify-between">
                                                        ...
                                                        <span className={`px-2 py-1 rounded-full text-sm ${
                                                            transaction.transaction_type === 'debit' ? 'bg-muted text-destructive' : 'bg-muted text-foreground'
                                                        }`}>
                                            ...
                                            <div className="flex items-center justify-between p-3 border-t bg-muted/50/50">
                                                <span className={`px-2 py-1 rounded-full text-sm ${
                                                    transaction.transaction_status === 'cleared' ? 'bg-muted text-foreground' :
                                                    transaction.transaction_status === 'pending' ? 'bg-muted text-foreground' :
                                                    'bg-muted text-destructive'
                                                }`}>

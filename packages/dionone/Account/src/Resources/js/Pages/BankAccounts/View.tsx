            ...
            <div className="overflow-y-auto flex-1 p-4 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{bankaccount.account_number}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Account Name')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{bankaccount.account_name}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Bank Name')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{bankaccount.bank_name}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Branch Name')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{bankaccount.branch_name || '-'}</p>
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{bankaccount.payment_gateway || '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Opening Balance')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{formatCurrency(bankaccount.opening_balance || 0)}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Current Balance')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{formatCurrency(bankaccount.current_balance || 0)}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('IBAN')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{bankaccount.iban || '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('SWIFT Code')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{bankaccount.swift_code || '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('Routing Number')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{bankaccount.routing_number || '-'}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-foreground">{t('GL Account')}</label>
                        <p className="text-sm text-foreground bg-muted/50 p-2 rounded">{bankaccount.gl_account?.account_name || '-'}</p>
                    </div>
                    <div className="space-y-2">

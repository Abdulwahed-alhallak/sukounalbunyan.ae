...
namespace DionONE\Telegram\Database\Seeders;
        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/dionone/Telegram/src/marketplace/' . $file->getFilename();
                }
            }
        }
                    ...
                    'dedication' => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'screenshot' => '/packages/dionone/Telegram/src/marketplace/image1.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/dionone/Telegram/src/marketplace/image2.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/dionone/Telegram/src/marketplace/image3.png'
                            ]
                        ]
                    ],
                    'screenshots' => [

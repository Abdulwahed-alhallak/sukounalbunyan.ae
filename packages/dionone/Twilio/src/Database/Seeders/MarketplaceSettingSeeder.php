...
namespace DionONE\Twilio\Database\Seeders;
        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/dionone/Twilio/src/marketplace/' . $file->getFilename();
                }
            }
        }
                    ...
                    'dedication'  => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'screenshot'  => '/packages/dionone/Twilio/src/marketplace/image1.png'
                            ],
                            [
                                ...
                                'screenshot'  => '/packages/dionone/Twilio/src/marketplace/image2.png'
                            ],
                            [
                                ...
                                'screenshot'  => '/packages/dionone/Twilio/src/marketplace/image3.png'
                            ]
                        ]
                    ],
                    'screenshots' => [

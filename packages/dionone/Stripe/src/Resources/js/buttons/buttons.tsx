            ...
            component: (
                <label className="cursor-pointer">
                    <input
                        ...
                        required
                    />
                    <div className={`p-4 border-2 rounded-lg transition-all hover:border-border flex items-center ${
                        isSelected ? 'border-destructive bg-muted/50' : 'border-border'
                    }`}>
                        <div className={`w-4 h-4 rounded-full border-2 mr-3 flex-shrink-0 ${
                            isSelected ? 'border-destructive bg-muted/500' : 'border-border'
                        }`}>
                            {isSelected && <div className="w-2 h-2 bg-card rounded-full m-auto mt-0.5"></div>}
                        </div>

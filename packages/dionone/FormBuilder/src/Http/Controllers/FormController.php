...
namespace DionONE\FormBuilder\Http\Controllers;
...
use DionONE\FormBuilder\Events\UpdateForm;
use DionONE\FormBuilder\Events\DestroyForm;
use DionONE\FormBuilder\Events\FormConverted;
use DionONE\FormBuilder\Http\Requests\StoreFormRequest;
use DionONE\FormBuilder\Http\Requests\UpdateFormRequest;
use DionONE\FormBuilder\Http\Requests\FormFieldRequest;
use DionONE\FormBuilder\Http\Requests\StoreFormConversionRequest;
    ...
    public function getConversionData(Form $form)
    {
        if (Auth::user()->can('manage-formbuilder-conversions')) {
            ...
            return response()->json([
                ...
                'lead_pipelines' => Module_is_active('Lead') && class_exists('\DionONE\Lead\Models\Pipeline') ? \DionONE\Lead\Models\Pipeline::where('created_by', creatorId())->select('id', 'name')->get() : [],
                'deal_pipelines' => Module_is_active('Lead') && class_exists('\DionONE\Lead\Models\DealPipeline') ? \DionONE\Lead\Models\DealPipeline::where('created_by', creatorId())->select('id', 'name')->get() : [],
                'clients' => Module_is_active('Lead') && class_exists('\DionONE\Lead\Models\User') ? \DionONE\Lead\Models\User::where('type', 'client')->where('created_by', creatorId())->select('id', 'name')->get() : [],
                'accounts' => Module_is_active('Sales') && class_exists('\DionONE\Sales\Models\Account') ? \DionONE\Sales\Models\Account::where('created_by', creatorId())->select('id', 'name')->get() : [],
                'opportunity_stages' => Module_is_active('Sales') && class_exists('\DionONE\Sales\Models\OpportunitiesStage') ? \DionONE\Sales\Models\OpportunitiesStage::where('created_by', creatorId())->select('id', 'name')->get() : [],
                'contract_types' => Module_is_active('Contract') && class_exists('\DionONE\Contract\Models\ContractType') ? \DionONE\Contract\Models\ContractType::where('created_by', creatorId())->select('id', 'name')->get() : [],
                'books' => Module_is_active('InternalKnowledge') && class_exists('\DionONE\Internalknowledge\Models\Book') ? \DionONE\Internalknowledge\Models\Book::where('created_by', creatorId())->select('id', 'title as name')->get() : [],
            ]);
        } else {

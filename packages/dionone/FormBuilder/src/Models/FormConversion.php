...
namespace DionONE\FormBuilder\Models;
            ...
            'Lead' => [
                'Lead' => [
                    ...
                    'pipeline_id' => [
                        'label' => 'Pipeline',
                        'type' => 'select',
                        'options' => Module_is_active('Lead') && class_exists('\DionONE\Lead\Models\Pipeline') ? \DionONE\Lead\Models\Pipeline::where('created_by', creatorId())->select('id', 'name')->get() : []
                    ],
                ],
                'Deal' => [
            ...
            'Sales' => [
                'Contact' => [
                    ...
                    'account_id' => [
                        'label' => 'Account',
                        'type' => 'select',
                        'options' => Module_is_active('Sales') && class_exists('\DionONE\Sales\Models\SalesAccount') ? \DionONE\Sales\Models\SalesAccount::where('created_by', creatorId())->where('is_active', true)
                ...
                'Opportunity' => [
                    ...
                    'contact_id' => [
                        'label' => 'Contact',
                        'type' => 'select',
                        'options' => Module_is_active('Sales') && class_exists('\DionONE\Sales\Models\SalesContact') ? \DionONE\Sales\Models\SalesContact::where('created_by', creatorId())->where('is_active', true)
                    ...
                    'stage_id' => [
                        ...
                        'type' => 'select',
                        'options' => Module_is_active('Sales') && class_exists('\DionONE\Sales\Models\SalesOpportunityStage') ? \DionONE\Sales\Models\SalesOpportunityStage::where('created_by', creatorId())
            ...
            'Contract' => [
                'Contract' => [
                    ...
                    'type_id' => [
                        'label' => 'Contract Type',
                        'type' => 'select',
                        'options' => Module_is_active('Contract') && class_exists('\DionONE\Contract\Models\ContractType') ? \DionONE\Contract\Models\ContractType::where('created_by', creatorId())->where('is_active', true)->select('id', 'name')->get() : []
                    ],
                ],
            ],
            'Internalknowledge' => [
                ...
                'Article' => [
                    ...
                    'internalknowledge_book_id' => [
                        'label' => 'Book',
                        'type' => 'select',
                        'options' => Module_is_active('Internalknowledge') && class_exists('\DionONE\Internalknowledge\Models\InternalknowledgeBook') ? \DionONE\Internalknowledge\Models\InternalknowledgeBook::where(function ($q) {

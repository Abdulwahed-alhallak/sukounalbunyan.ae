...
use DionONE\Lead\Http\Requests\StoreDealRequest;
use DionONE\Lead\Http\Requests\UpdateDealRequest;
...
use DionONE\Lead\Http\Requests\StoreDealCallRequest;
use DionONE\Lead\Http\Requests\UpdateDealCallRequest;
use DionONE\Lead\Http\Requests\StoreDealEmailRequest;
use DionONE\Lead\Http\Requests\StoreDealDiscussionRequest;
use DionONE\Lead\Models\ClientPermission;
use DionONE\Lead\Models\DealActivityLog;
...
use DionONE\Lead\Events\UpdateDeal;
use DionONE\Lead\Events\DestroyDeal;
use DionONE\Lead\Events\DealMoved;
use DionONE\Lead\Events\DealAddUser;
use DionONE\Lead\Events\DestroyUserDeal;
use DionONE\Lead\Events\DealAddClient;
use DionONE\Lead\Events\DestroyDealClient;
use DionONE\Lead\Events\DealAddProduct;
use DionONE\Lead\Events\DestroyDealProduct;
use DionONE\Lead\Events\DealUploadFile;
use DionONE\Lead\Events\DestroyDealFile;
use DionONE\Lead\Events\DealSourceUpdate;
use DionONE\Lead\Events\DestroyDealSource;
use DionONE\Lead\Events\DealAddDiscussion;
use DionONE\Lead\Events\DealAddCall;
use DionONE\Lead\Events\DealCallUpdate;
use DionONE\Lead\Events\DestroyDealCall;
use DionONE\Lead\Events\DealAddEmail;
        ...
        try {
            if (Auth::user()->can('view-deals')) {
                if ($deal->created_by == creatorId()) {
                    ...
                    $availableSources = \DionONE\Lead\Models\Source::where('created_by', creatorId())->get(['id', 'name']);

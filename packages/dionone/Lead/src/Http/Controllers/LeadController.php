...
namespace DionONE\Lead\Http\Controllers;

use App\Models\EmailTemplate;
use App\Models\User;
use DionONE\Lead\Models\Lead;
use DionONE\Lead\Http\Requests\StoreLeadRequest;
use DionONE\Lead\Http\Requests\UpdateLeadRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use DionONE\Lead\Models\LeadStage;
use DionONE\Lead\Models\Pipeline;
use DionONE\Lead\Models\UserLead;
use DionONE\Lead\Models\Label;
use DionONE\ProductService\Models\ProductServiceItem;
use Illuminate\Http\Request;
use DionONE\Lead\Http\Requests\AssignUsersRequest;
use DionONE\Lead\Http\Requests\StoreLeadCallRequest;
use DionONE\Lead\Http\Requests\UpdateLeadCallRequest;
use DionONE\Lead\Models\LeadActivityLog;
use DionONE\Lead\Models\LeadCall;
use DionONE\Lead\Models\LeadDiscussion;
use DionONE\Lead\Models\LeadEmail;
use DionONE\Lead\Models\LeadFile;
use DionONE\Lead\Models\Deal;
use DionONE\Lead\Http\Requests\ConvertToDealRequest;
use DionONE\Lead\Http\Requests\StoreLeadEmailRequest;
use DionONE\Lead\Http\Requests\StoreLeadDiscussionRequest;
...
use DionONE\Lead\Models\ClientDeal;
use Spatie\Permission\Models\Role;
use DionONE\Lead\Models\UserDeal;
use DionONE\Lead\Events\CreateLead;
use DionONE\Lead\Events\UpdateLead;
use DionONE\Lead\Events\DestroyLead;
use DionONE\Lead\Events\LeadMoved;
use DionONE\Lead\Events\LeadAddUser;
use DionONE\Lead\Events\DestroyUserLead;
use DionONE\Lead\Events\LeadAddProduct;
use DionONE\Lead\Events\DestroyLeadProduct;
use DionONE\Lead\Events\LeadUploadFile;
use DionONE\Lead\Events\DestroyLeadFile;
use DionONE\Lead\Events\LeadSourceUpdate;
use DionONE\Lead\Events\DestroyLeadSource;
use DionONE\Lead\Events\LeadAddDiscussion;
use DionONE\Lead\Events\LeadAddCall;
use DionONE\Lead\Events\LeadCallUpdate;
use DionONE\Lead\Events\DestroyLeadCall;
use DionONE\Lead\Events\LeadAddEmail;
...
class LeadController extends Controller
{
    ...
    public function store(StoreLeadRequest $request)
    {
        if (Auth::user()->can('create-leads')) {
            ...
            if (empty($stage)) {
                ...
                $lead->syncAttachments($request->media_paths);
    ...
    public function destroyAttachment($attachmentId)
    {
        if (Auth::user()->can('edit-leads')) {
            $attachment = \DionONE\Taskly\Models\TaskAttachment::find($attachmentId);
            if ($attachment) {
                $attachment->delete();

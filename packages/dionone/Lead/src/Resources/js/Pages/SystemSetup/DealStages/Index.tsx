                        ...
                        {auth.user?.permissions?.includes('edit-deal-stages') && (
                            <Tooltip delayDuration={0}>
                                <TooltipTrigger asChild>
                                    <Button variant="ghost" size="sm" onClick={() => openModal('edit', dealstage)} className="h-8 w-8 p-0 text-foreground hover:text-foreground">
                                        ...
                                        <div className="space-y-3">
                                            {filteredStages
                                                ...
                                                <div
                                                    ...
                                                    className="flex items-center gap-3 p-4 border rounded-lg bg-card border-border hover:shadow-md transition-all cursor-move"
                                                >

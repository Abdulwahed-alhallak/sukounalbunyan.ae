        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => window.location.href = route('lead.reports.leads')}>
                    <CardHeader className="pb-3">
                        <div className="flex items-center space-x-3">
                            <div className="p-2 rounded-lg bg-muted/500 text-background">
                    ...
                    <CardContent>
                        <p className="text-muted-foreground mb-4">{t('View detailed lead analytics and reports')}</p>
                ...
                <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => window.location.href = route('lead.reports.deals')}>
                    ...
                    <CardContent>
                        <p className="text-muted-foreground mb-4">{t('View detailed deal analytics and reports')}</p>
                        <Button variant="outline" size="sm">
                            {t('View Reports')}
                        </Button>
                    </CardContent>

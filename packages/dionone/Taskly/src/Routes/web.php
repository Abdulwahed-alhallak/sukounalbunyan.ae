...
use DionONE\Taskly\Http\Controllers\DashboardController;
use DionONE\Taskly\Http\Controllers\ProjectController;
use DionONE\Taskly\Http\Controllers\ProjectTaskController;
use DionONE\Taskly\Http\Controllers\TaskStageController;
use DionONE\Taskly\Http\Controllers\BugStageController;
use DionONE\Taskly\Http\Controllers\ProjectBugController;
use DionONE\Taskly\Http\Controllers\ProjectReportController;
...
Route::middleware(['web', 'auth', 'verified', 'PlanModuleCheck:Taskly'])->group(function () {
    ...
    Route::get('/project/tasks/gantt/{project}', [ProjectController::class, 'gantt'])->name('project.gantt');
    ...
    // Task Timers
    Route::get('/project/tasks/{task}/timers', [\DionONE\Taskly\Http\Controllers\TaskTimerController::class, 'getTimers'])->name('project.tasks.timers.index');
    Route::post('/project/tasks/{task}/timers/start', [\DionONE\Taskly\Http\Controllers\TaskTimerController::class, 'start'])->name('project.tasks.timers.start');
    Route::post('/project/tasks/{task}/timers/stop', [\DionONE\Taskly\Http\Controllers\TaskTimerController::class, 'stop'])->name('project.tasks.timers.stop');
    ...
    // Project expenses
    Route::post('/project/{project}/expenses', [\DionONE\Taskly\Http\Controllers\ProjectExpenseController::class, 'store'])->name('project.expenses.store');
    Route::delete('/project/expenses/{expense}', [\DionONE\Taskly\Http\Controllers\ProjectExpenseController::class, 'destroy'])->name('project.expenses.destroy');

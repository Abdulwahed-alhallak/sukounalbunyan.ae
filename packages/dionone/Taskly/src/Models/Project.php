...
class Project extends Model
{
    ...
    {
        return $this->hasMany(\DionONE\Taskly\Models\ProjectMilestone::class);
    }

    public function tasks()
    {
        return $this->hasMany(\DionONE\Taskly\Models\ProjectTask::class);
    }

    public function bugs()
    {
        return $this->hasMany(\DionONE\Taskly\Models\ProjectBug::class);
    }

    public function activityLogs()
    {
        return $this->hasMany(\DionONE\Taskly\Models\ActivityLog::class);
    }

    public function files()
    {
        return $this->hasMany(\DionONE\Taskly\Models\ProjectFile::class);
    }

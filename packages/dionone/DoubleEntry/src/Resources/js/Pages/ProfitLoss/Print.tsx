...
export default function Print() {
    ...
    return (
        <div className="min-h-screen bg-card">
            ...
            <div className="profit-loss-container bg-card max-w-4xl mx-auto p-12">
                {/* Header */}
                ...
                <div className="grid grid-cols-2 gap-8 mb-6">
                    {/* Left Column - Revenue */}
                    <div>
                        <h3 className="text-base font-bold border-b-2 border-border pb-2 mb-3">{t('Revenue')}</h3>
                    ...
                    <div>
                        <h3 className="text-base font-bold border-b-2 border-border pb-2 mb-3">{t('Expenses')}</h3>

...
namespace DionONE\SupportTicket\Database\Seeders;
        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/dionone/SupportTicket/src/marketplace/' . $file->getFilename();
                }
            }
        }
        ...
        MarketplaceSetting::firstOrCreate(['module' => 'SupportTicket'], [
            ...
            'config_sections' => [
                'sections' => [
                    'hero' => [
                        'variant' => 'hero1',
                        'title' => 'SupportTicket Module for DionCreative',
                    ...
                    'dedication' => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'screenshot' => '/packages/dionone/SupportTicket/src/marketplace/image1.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/dionone/SupportTicket/src/marketplace/image2.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/dionone/SupportTicket/src/marketplace/image3.png'
                            ]
                        ]
                    ],
                    'screenshots' => [

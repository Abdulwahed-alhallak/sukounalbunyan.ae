...
namespace DionONE\SupportTicket\Http\Controllers;
...
use DionONE\SupportTicket\Events\CreateTicket;
use DionONE\SupportTicket\Events\CreateTicketConversion;
use DionONE\SupportTicket\Events\DestroyTicket;
use DionONE\SupportTicket\Events\UpdateTicket;
use DionONE\SupportTicket\Http\Requests\StoreSupportTicketRequest;
use DionONE\SupportTicket\Http\Requests\UpdateSupportTicketRequest;
use DionONE\SupportTicket\Http\Requests\StoreConversionRequest;
use DionONE\SupportTicket\Models\Ticket;
use DionONE\SupportTicket\Models\TicketCategory;
use DionONE\SupportTicket\Models\Conversion;
use DionONE\SupportTicket\Models\SupportTicketSetting;
...
class SupportTicketController extends Controller
{
    ...
    private function getBrandSettings()
    {
        ...
        return [
            'logo_dark' => $settings['logo_dark'] ?? asset('packages/dionone/SupportTicket/src/Resources/assets/images/logo.png'),
            'favicon' => $settings['favicon'] ?? '/packages/dionone/SupportTicket/src/Resources/assets/images/favicon.png',

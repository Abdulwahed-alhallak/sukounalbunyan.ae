        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="bg-gradient-to-r from-muted/50 to-muted border-border">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-foreground">{t('Total Requests')}</CardTitle>
          ...
          <Card className="bg-gradient-to-r from-muted/50 to-muted border-border">
            ...
            <CardContent>
              ...
              <p className="text-xs text-foreground mt-1">{t('Active requests')}</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-r from-muted/50 to-muted border-border">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-foreground">{t('Today\'s Requests')}</CardTitle>

...
export default function BrandSettings() {
    ...
    const defaultImages = {
        logo_dark: getImagePath('/packages/dionone/SupportTicket/src/Resources/assets/images/logo.png'),
        favicon: getImagePath('/packages/dionone/SupportTicket/src/Resources/assets/images/favicon.png')
    };
            ...
            <div className="flex flex-col md:flex-row gap-8">
                ...
                <CardContent className="p-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-3">
                                <Label htmlFor="titleText">{t('Title Text')} <span className="text-destructive">*</span></Label>
                                <Input
                                    id="titleText"
                                    name="titleText"
                            ...
                            <div className="space-y-3">
                                <Label htmlFor="footerText">{t('Footer Text')} <span className="text-destructive">*</span></Label>
                                <Input
                                    id="footerText"
                                    name="footerText"

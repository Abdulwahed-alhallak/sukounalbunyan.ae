...
export default function Index() {
    ...
    const tableColumns = [
        ...
        },
        {
            ...
            sortable: false,
            render: (_: any, link: QuickLink) => (
                <span className="px-2 py-1 rounded-full text-xs font-medium bg-muted text-foreground">{link.icon}</span>
            )
        },
        {
            key: 'link',
            ...
            sortable: false,
            render: (_: any, link: QuickLink) => (
                <div className="text-sm text-muted-foreground truncate max-w-xs">{link.link}</div>
            )
        },

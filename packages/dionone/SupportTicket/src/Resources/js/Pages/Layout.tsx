...
export default function Layout({ children, title = "Support Ticket", brandSettings }: SupportTicketLayoutProps) {
    ...
    return (
        <>
            <Head title={title}>
                <link rel="icon" type="image/png" href={brandSettings?.favicon || '/packages/dionone/SupportTicket/src/Resources/assets/images/favicon.png'} />
            </Head>
            ...
            <div className="min-h-screen font-sans relative overflow-x-hidden" style={{
                ...
                <div className="container mx-auto px-4 py-4 max-w-7xl relative z-10">
                            ...
                            <div className="flex flex-wrap justify-between items-center">
                                ...
                                <h1>
                                    <a href="#" className="flex items-center space-x-3 lg:max-w-none max-w-[120px]">
                                        <img src={brandSettings?.logo_dark || '/packages/dionone/SupportTicket/src/Resources/assets/images/logo.png'} alt="DionONE Support" className="h-8" />
                                    </a>
                                </h1>
                    ...
                    <footer className="mt-8 md:mt-12 text-center text-muted-foreground text-sm">
                        <p>{t(`© ${new Date().getFullYear()} DionONE Support System. All rights reserved.`)}</p>

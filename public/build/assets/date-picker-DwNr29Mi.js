import{r as C,j as e}from"./ui-CPJPuvru.js";import{D}from"./react-datepicker-DG_6vpqQ.js";import{c as d}from"./utils-nT-0gv3l.js";import{B as S}from"./button-DGd1Somz.js";import{P,a as E,b as N}from"./popover-D1G_-hUe.js";import{u as $}from"./useTranslation-DIEPswRS.js";import{C as B}from"./calendar-amYgt1bn.js";function I({value:a,onChange:c,placeholder:i,className:s,id:p,required:l,maxDate:k,minDate:u,showYearDropdown:h=!0,showMonthDropdown:g=!0,style:m}){const{t:w}=$(),[_,n]=C.useState(!1),f=r=>r?new Date(r):null,x=r=>{if(!r)return"";const o={year:"numeric",month:"short",day:"numeric"};return r.toLocaleDateString("en-US",o)},t=f(a),v=r=>{if(r){const o=r.getFullYear(),b=String(r.getMonth()+1).padStart(2,"0"),y=String(r.getDate()).padStart(2,"0"),j=`${o}-${b}-${y}`;c(j),n(!1)}else c("")};return e.jsxs("div",{className:d("w-full",s),children:[p&&e.jsx("input",{id:p,type:"hidden",value:a||"",required:l}),e.jsxs(P,{open:_,onOpenChange:n,children:[e.jsx(E,{asChild:!0,children:e.jsxs(S,{variant:"outline",className:d("h-10 w-full justify-start text-left font-normal",!a&&"text-muted-foreground"),style:m,children:[e.jsx(B,{className:"mr-2 h-4 w-4"}),a&&t?x(t):i||w("Select date")]})}),e.jsx(N,{className:"w-auto p-0",align:"start",children:e.jsx("div",{className:"date-picker-wrapper",children:e.jsx(D,{selected:t,onChange:v,inline:!0,showPopperArrow:!1,maxDate:k,minDate:u,showYearDropdown:h,showMonthDropdown:g,dropdownMode:"select",yearDropdownItemNumber:100})})})]}),e.jsx("style",{children:`

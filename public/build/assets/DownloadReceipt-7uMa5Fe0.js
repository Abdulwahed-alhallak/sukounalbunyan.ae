import{_ as y}from"./vendor-DJjzF8sm.js";import{a as x,f as s}from"./helpers-BdCNhlpe.js";import"./app-CjxRUKl3.js";const l=async(n,a)=>{var r,d;const v=`
        <div class="receipt">
            <div class="header">
    ...
    `,t=document.createElement("div");t.innerHTML=v,document.body.appendChild(t);const f={margin:.1,filename:`receipt-${n.pos_number}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2},jsPDF:{unit:"mm",format:[80,297],orientation:"portrait"}};try{await y().set(f).from(t).save()}catch(i){console.error("PDF generation failed:",i)}finally{document.body.removeChild(t)}};export{l as downloadReceiptPDF};

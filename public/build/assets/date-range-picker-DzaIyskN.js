import{S as w,r as v,j as a,ab as b}from"./vendor-DJjzF8sm.js";import{c as p}from"./utils-BkfiQ9Th.js";import{B as S}from"./button-DZDX_WaT.js";import{P as y,a as x,b as $}from"./popover-DIA8Rv1r.js";import{g as j}from"./icons-BJYW6LHv.js";function Y({value:o,onChange:d,placeholder:l,className:g,id:D,required:P}){const{t:u}=w(),[h,i]=v.useState(!1),m=t=>{if(!t)return[null,null];const[r,e]=t.split(" - ");return[r?new Date(r):null,e?new Date(e):null]},f=(t,r)=>{if(!t||!r)return"";const e={year:"numeric",month:"short",day:"numeric"};return`${t.toLocaleDateString("en-US",e)} - ${r.toLocaleDateString("en-US",e)}`},[n,c]=m(o),_=t=>{const[r,e]=t;if(r&&e){const s=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,"0")}-${String(r.getDate()).padStart(2,"0")}`,k=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`;d(`${s} - ${k}`),i(!1)}else if(r&&!e){const s=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,"0")}-${String(r.getDate()).padStart(2,"0")}`;d(`${s} - `)}else d("")};return a.jsxs("div",{className:p("w-full",g),children:[a.jsxs(y,{open:h,onOpenChange:i,children:[a.jsx(x,{asChild:!0,children:a.jsxs(S,{variant:"outline",className:p("h-10 w-full justify-start text-start font-normal",!o&&"text-muted-foreground"),children:[a.jsx(j,{className:"me-2 h-4 w-4"}),o&&n&&c?f(n,c):l||u("Select date range")]})}),a.jsx($,{className:"w-auto p-0",align:"start",children:a.jsx("div",{className:"date-range-wrapper",children:a.jsx(b,{selected:n,onChange:_,startDate:n,endDate:c,selectsRange:!0,monthsShown:2,inline:!0,showPopperArrow:!1})})})]}),a.jsx("style",{children:`

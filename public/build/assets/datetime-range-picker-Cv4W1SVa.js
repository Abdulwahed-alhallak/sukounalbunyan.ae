import{r as g,j as r}from"./ui-CPJPuvru.js";import{D as v}from"./react-datepicker-DG_6vpqQ.js";import{c as k}from"./utils-TX_E7qIt.js";import{B as y}from"./button-wnXVyq15.js";import{P as D,a as T,b as $}from"./popover-DWhgoBme.js";import{u as N}from"./useTranslation-CV_3kzxc.js";import{C}from"./calendar-amYgt1bn.js";function R({value:i,onChange:d,placeholder:_,className:w,id:P,required:E,timeFormat:u="HH:mm",dateFormat:h="MMM d, yyyy h:mm aa",mode:t="range"}){const{t:c}=N(),[x,f]=g.useState(!1),[a,m]=g.useState(null),[o,p]=g.useState(null);g.useEffect(()=>{if(i)if(t==="single")m(new Date(i.replace(" ","T"))),p(null);else{const[e,n]=i.split(" - ");m(e?new Date(e.replace(" ","T")):null),p(n?new Date(n.replace(" ","T")):null)}else m(null),p(null)},[i,t]);const S=(e,n)=>{const l={year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"};return t==="single"?e?e.toLocaleDateString("en-US",l):"":!e||!n?"":`${e.toLocaleDateString("en-US",l)} - ${n.toLocaleDateString("en-US",l)}`},s=e=>{const n=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`,l=`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`;return`${n} ${l}`},b=e=>{e&&(m(e),t==="single"?(d(s(e)),f(!1)):d(o?`${s(e)} - ${s(o)}`:`${s(e)} - `))},j=e=>{e&&a&&(p(e),d(`${s(a)} - ${s(e)}`),f(!1))};return r.jsxs("div",{className:k("w-full",w),onWheel:e=>{x||e.stopPropagation()},children:[r.jsxs(D,{open:x,onOpenChange:f,modal:!1,children:[r.jsx(T,{asChild:!0,children:r.jsxs(y,{variant:"outline",className:k("h-10 w-full justify-start text-left font-normal",!i&&"text-muted-foreground"),children:[r.jsx(C,{className:"mr-2 h-4 w-4"}),i&&a&&(t==="single"||o)?S(a,o):_||c(t==="single"?"Select date time":"Select date time range")]})}),r.jsx($,{className:"w-auto p-0",align:"start",onWheel:e=>{e.stopPropagation()},children:r.jsx("div",{className:"datetime-range-wrapper",children:t==="single"?r.jsxs("div",{className:"p-3",children:[r.jsx("div",{className:"mb-2 text-center text-sm font-medium",children:c("Select Date & Time")}),r.jsx(v,{selected:a,onChange:b,showTimeSelect:!0,timeFormat:u,timeIntervals:15,timeCaption:"Time",dateFormat:h,inline:!0})]}):r.jsxs("div",{className:"flex",children:[r.jsxs("div",{className:"border-r border-border p-3",children:[r.jsx("div",{className:"mb-2 text-center text-sm font-medium",children:c("Start Date & Time")}),r.jsx(v,{selected:a,onChange:b,showTimeSelect:!0,timeFormat:u,timeIntervals:15,timeCaption:"Time",dateFormat:h,inline:!0,maxDate:o||void 0})]}),r.jsxs("div",{className:"p-3",children:[r.jsx("div",{className:"mb-2 text-center text-sm font-medium",children:c("End Date & Time")}),r.jsx(v,{selected:o,onChange:j,showTimeSelect:!0,timeFormat:u,timeIntervals:15,timeCaption:"Time",dateFormat:h,inline:!0,minDate:a||void 0})]})]})})})]}),r.jsx("style",{children:`

import{S as C,r as S,j as e,ab as D}from"./vendor-DJjzF8sm.js";import{c as d}from"./utils-BkfiQ9Th.js";import{B as P}from"./button-DZDX_WaT.js";import{P as E,a as N,b as $}from"./popover-DIA8Rv1r.js";import{g as B}from"./icons-BJYW6LHv.js";function A({value:a,onChange:c,placeholder:i,className:s,id:n,required:l,maxDate:k,minDate:u,showYearDropdown:h=!0,showMonthDropdown:g=!0,style:m}){const{t:w}=C(),[_,p]=S.useState(!1),x=r=>r?new Date(r):null,b=r=>{if(!r)return"";const o={year:"numeric",month:"short",day:"numeric"};return r.toLocaleDateString("en-US",o)},t=x(a),f=r=>{if(r){const o=r.getFullYear(),v=String(r.getMonth()+1).padStart(2,"0"),y=String(r.getDate()).padStart(2,"0"),j=`${o}-${v}-${y}`;c(j),p(!1)}else c("")};return e.jsxs("div",{className:d("w-full",s),children:[n&&e.jsx("input",{id:n,type:"hidden",value:a||"",required:l}),e.jsxs(E,{open:_,onOpenChange:p,children:[e.jsx(N,{asChild:!0,children:e.jsxs(P,{variant:"outline",className:d("h-10 w-full justify-start text-start font-normal",!a&&"text-muted-foreground"),style:m,children:[e.jsx(B,{className:"me-2 h-4 w-4"}),a&&t?b(t):i||w("Select date")]})}),e.jsx($,{className:"w-auto p-0",align:"start",children:e.jsx("div",{className:"date-picker-wrapper",children:e.jsx(D,{selected:t,onChange:f,inline:!0,showPopperArrow:!1,maxDate:k,minDate:u,showYearDropdown:h,showMonthDropdown:g,dropdownMode:"select",yearDropdownItemNumber:100})})})]}),e.jsx("style",{children:`

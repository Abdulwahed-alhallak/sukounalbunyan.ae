const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./vendor-DJjzF8sm.js","./vendor-CE21K4bl.css"])))=>i.map(i=>d[i]);
import{_ as f}from"./app-CjxRUKl3.js";import{S as x,j as i}from"./vendor-DJjzF8sm.js";import{B as h}from"./button-DZDX_WaT.js";import{a as v,b as u,c as b}from"./tooltip-CBNEnByy.js";import{f as _,a as n,k as s}from"./helpers-BdCNhlpe.js";import{Y as y}from"./icons-BJYW6LHv.js";import"./radix-D_kDPCra.js";import"./utils-BkfiQ9Th.js";function S({contract:e,variant:a="outline",size:p="sm"}){const{t}=x(),m=()=>{var l,d;const r=document.createElement("div");r.innerHTML=`
        ...
        `;const g={margin:.5,filename:`contract-${e.contract_number}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2},jsPDF:{unit:"in",format:"letter",orientation:"portrait"}};f(()=>import("./vendor-DJjzF8sm.js").then(o=>o.h),__vite__mapDeps([0,1]),import.meta.url).then(o=>{o.default().set(g).from(r).save()})};return i.jsxs(v,{children:[i.jsx(u,{asChild:!0,children:i.jsx(h,{variant:a,size:p,onClick:m,children:i.jsx(y,{className:"h-4 w-4"})})}),i.jsx(b,{children:i.jsx("p",{children:t("Download PDF")})})]})}export{S as default};

import{a as y,f as o}from"./helpers-BdCNhlpe.js";import"./vendor-DJjzF8sm.js";import"./app-CjxRUKl3.js";const $=(t,i)=>{var e,p,d,r,m;const f=`
    <!DOCTYPE html>
    <html>
    <head>
    ...
    `,n=document.createElement("iframe");n.style.display="none",document.body.appendChild(n);const s=n.contentDocument||((d=n.contentWindow)==null?void 0:d.document);s&&(s.write(f),s.close(),(r=n.contentWindow)==null||r.focus(),(m=n.contentWindow)==null||m.print(),setTimeout(()=>{document.body.removeChild(n)},1e3))};export{$ as printReceipt};

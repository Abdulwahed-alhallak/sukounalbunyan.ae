...
conn.on('ready', () => {
    conn.exec('ls -la domains/sukounalbunyan.ae/public_html/backend/manifest.json domains/sukounalbunyan.ae/public_html/backend/public/manifest.json', (err, stream) => {
        if (err) throw err;

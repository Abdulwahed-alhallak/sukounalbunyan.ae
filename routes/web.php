...
Route::middleware(['auth', 'PlanModuleCheck'])->group(function () {
    ...
    Route::post('notifications/{notification}/archive', [UserNotificationController::class, 'archive'])->name('notifications.archive');
    Route::post('notifications/archive-read', [UserNotificationController::class, 'archiveAllRead'])->name('notifications.archive-read');

    // Report Center routes
    Route::get('reports', [ReportCenterController::class, 'index'])->name('reports.index');
    Route::get('reports/{reportType}', [ReportCenterController::class, 'generate'])->name('reports.generate');
    Route::get('reports/{reportType}/export-csv', [ReportCenterController::class, 'exportCsv'])->name('reports.export-csv');

    // Workflow Automation routes
    Route::get('workflows', [WorkflowController::class, 'index'])->name('workflows.index');
    Route::post('workflows', [WorkflowController::class, 'store'])->name('workflows.store');
    Route::put('workflows/{workflow}', [WorkflowController::class, 'update'])->name('workflows.update');
    Route::post('workflows/{workflow}/toggle', [WorkflowController::class, 'toggleActive'])->name('workflows.toggle');
    Route::delete('workflows/{workflow}', [WorkflowController::class, 'destroy'])->name('workflows.destroy');
    Route::get('workflows/logs', [WorkflowController::class, 'logs'])->name('workflows.logs');
    ...
    // Audit Logs routes (superadmin & company only)
    Route::get('audit-logs', [AuditLogController::class, 'index'])->name('audit-logs.index');
    Route::get('audit-logs/security', [AuditLogController::class, 'security'])->name('audit-logs.security');

...
export function RichTextEditor({ 
  ...
  const editor = useEditor({
    extensions: [
      ...
      Link.configure({ 
        openOnClick: false,
        HTMLAttributes: {
          class: 'text-foreground underline cursor-pointer hover:text-foreground',
        },
      }),
      Color,
      TextStyle,
  ...
  return (
    <div className={cn('border rounded-md', className)}>
      ...
      <div className="prose prose-sm max-w-none [&_ul]:list-disc [&_ul]:ml-6 [&_ol]:list-decimal [&_ol]:ml-6 [&_li]:my-1 [&_a]:text-foreground [&_a]:underline [&_a]:cursor-pointer hover:[&_a]:text-foreground">
        <EditorContent 
          editor={editor} 

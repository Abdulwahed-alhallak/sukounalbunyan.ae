          ...
          return (
            <div key={`checkbox-wrapper-${item.id}-${field.name}`} className="flex items-center space-x-3 py-2">
              <Checkbox
                ...
                className={cn("data-[state=checked]:bg-foreground data-[state=checked]:border-foreground", field.className)}
              />
              <label 
          ...
          return (
            <div className="space-y-2">
              <Slider
                ...
                className={field.className}
              />
              <div className="text-sm text-muted-foreground text-center">{fieldValue || field.min || 0}</div>
            </div>
          )
      ...
      <TooltipProvider>
        <div className={cn("space-y-4", className)}>
          <div className="max-h-96 overflow-y-auto space-y-4 pr-2">
            ...
            <div key={`repeater-item-${item.id || index}`} className="border rounded-lg p-4 bg-muted/50/50">

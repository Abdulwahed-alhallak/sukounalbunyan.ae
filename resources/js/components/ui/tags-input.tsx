    ...
    (
        ...
        const filteredOptions = React.useMemo(() => {
            ...
            return options.filter(
                (option) =>
                    option.label.toLowerCase().includes(inputValue.toLowerCase()) && !value.includes(option.value)
            );
        ...
        return (
            <div ref={containerRef} className="relative">
                ...
                {showOptions && filteredOptions.length > 0 && (
                    <div className="absolute z-50 mt-1 max-h-48 w-full overflow-y-auto rounded-md border border-input bg-background shadow-lg">

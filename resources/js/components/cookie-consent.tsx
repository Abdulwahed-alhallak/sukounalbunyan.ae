            ...
            <div className="rounded-xl border border-border bg-background shadow-2xl backdrop-blur-sm">
                <div className="flex items-start justify-between p-3">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-base font-semibold">{settings.cookieTitle || t('Cookie Consent')}</h3>
                    </div>
                    <Button
                        variant="ghost"
                        size="sm"
                    ...
                    <div className="flex items-start gap-4">
                        <div className="flex-1">
                            ...
                            {settings.strictlyNecessaryCookies && (
                                <div className="mb-2 flex items-center justify-between rounded-lg bg-muted/30 p-2">
                                    <div className="flex-1">
                                        <p className="text-sm font-medium">{settings.strictlyCookieTitle}</p>

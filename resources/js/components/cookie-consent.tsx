        ...
        <div className="px-3 pb-3">
          <div className="flex items-start gap-4">
            <div className="flex-1">
              ...
              {settings.contactUsUrl && (
                <p className="text-xs text-muted-foreground">
                  ...
                  <a href={settings.contactUsUrl} className="text-foreground hover:underline font-medium">
                    {t('Contact us')}
                  </a>
                </p>
              )}
            ...
            <div className="flex flex-col gap-2 min-w-[140px]">
              <Button size="sm" onClick={handleAcceptAll} className="w-full bg-foreground hover:bg-foreground/90">
                {t('Accept All')}
              </Button>

    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="space-y-6">
                    ...
                    {showFilters && (
                        <div className="mt-4 grid grid-cols-1 gap-3 border-t border-border pt-4 sm:grid-cols-4">
                            ...
                            <select
                                ...
                                onChange={(e) =>
                                    handleFilter("model_type", e.target.value)
                                }
                                className="rounded-lg border border-border bg-background px-3 py-2 text-sm text-foreground"
                            >
                ...
                {/* Audit Log Table */}
                <div className="overflow-hidden rounded-xl border border-border/50 bg-card/60 backdrop-blur-md shadow-xl transition-all">
                                            ...
                                            >
                                                        ...
                                                        <div className="flex flex-wrap gap-1.5">
                                                            {log.changed_fields
                                                                ...
                                                                .map((f) => (
                                                                    <span
                                                                        key={f}
                                                                        className="inline-flex items-center rounded-md bg-foreground/5 px-2 py-0.5 text-[10px] font-semibold text-foreground/80 border border-foreground/10"
                                                                    >
                                                                        {f}
                                                                    </span>
                                                                ))}
                                                            {log.changed_fields
                                                                .length > 4 && (
                                                                <span className="text-[10px] text-muted-foreground font-bold bg-muted/50 px-1.5 py-0.5 rounded-md">
                                                                    +
                                                                    {log
                                                                        .changed_fields
                                                                        .length -
                                                ...
                                                <td className="px-4 py-3">
                                                    <div className="flex flex-col gap-0.5">
                                                        ...
                                                        <span className="text-[9px] uppercase tracking-tighter text-muted-foreground/40 font-bold">
                                                            {log.method} •{" "}
                                                            {log.route_name ||
                                                                "System"}
                                                        </span>
                    ...
                    {logs.last_page > 1 && (
                        <div className="flex items-center justify-between border-t border-border px-4 py-3">
                            <div className="text-sm text-muted-foreground">
                                {t("Showing")} {logs.from} - {logs.to} {t("of")}{" "}
                                {logs.total}
                            </div>

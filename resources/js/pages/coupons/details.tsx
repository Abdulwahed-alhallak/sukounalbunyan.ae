    ...
    const tableColumns = [
        ...
        },
        {
            ...
            render: (_: any, record: UserCoupon) =>
                record?.created_at ? formatDate(record.created_at, pageProps) : 'N/A',
        },
    ];

    return (
        <AuthenticatedLayout
            breadcrumbs={[{ label: t('Coupons'), url: route('coupons.index') }, { label: coupon.name }]}
                ...
                <CardContent className="bg-muted/50/50 border-b p-6">
                    <div className="flex items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            <PerPageSelector routeName="coupons.show" filters={{ ...filters, coupon_id: coupon.id }} />
                        </div>
                    </div>
                </CardContent>

                            ...
                            <div>
                                ...
                                <div className="mt-4 p-3 bg-muted rounded">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <div className="text-right">
                                            <div className="text-xl font-bold text-foreground">{formatCurrency(purchaseReturn.total_amount)}</div>
                            ...
                            <div className="w-80 space-y-3">
                                ...
                                {purchaseReturn.discount_amount > 0 && (
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="font-medium text-destructive">-{formatCurrency(purchaseReturn.discount_amount)}</span>
                                    </div>
                                )}

            ...
            <div className="space-y-6">
                ...
                <Card>
                    <CardContent className="p-6">
                        ...
                        <div
                            className={`grid grid-cols-1 gap-6 ${purchaseReturn.vendor_details?.billing_address || purchaseReturn.vendor_details?.shipping_address ? 'md:grid-cols-3' : 'md:grid-cols-2'}`}
                        >
                            <div>
                                ...
                                {purchaseReturn.vendor_details?.billing_address && (
                                    <div className="mt-3">
                                        ...
                                        <div className="space-y-1 text-sm text-muted-foreground">
                                            ...
                                            <div>
                                                {purchaseReturn.vendor_details.billing_address.city},{' '}
                                                {purchaseReturn.vendor_details.billing_address.state}{' '}
                                                {purchaseReturn.vendor_details.billing_address.zip_code}
                                            </div>
                                        </div>
                                    </div>
                                )}
                            ...
                            {purchaseReturn.vendor_details?.shipping_address && (
                                <div>
                                    ...
                                    <div className="space-y-1 text-sm text-muted-foreground">
                                        ...
                                        <div>
                                            {purchaseReturn.vendor_details.shipping_address.city},{' '}
                                            {purchaseReturn.vendor_details.shipping_address.state}{' '}
                                            {purchaseReturn.vendor_details.shipping_address.zip_code}
                                        </div>
                                    </div>
                                </div>
                            )}
                                            ...
                                            {purchaseReturn.status === 'draft' &&
                                                auth.user?.permissions?.includes(
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() =>
                                                            router.post(
                                                                route('purchase-returns.approve', purchaseReturn.id),
                                                                {},
                                                                {
                                                                    onSuccess: () => {
                                                                        router.reload();
                        ...
                        {purchaseReturn.notes && (
                            <div className="mt-4 border-t pt-4">
                                ...
                                <span className="ms-2 text-sm text-muted-foreground">{purchaseReturn.notes}</span>
                            </div>
                        )}
                    </CardContent>
                </Card>

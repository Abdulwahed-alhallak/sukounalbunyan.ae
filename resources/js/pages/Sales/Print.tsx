            ...
            <div className="invoice-container mx-auto max-w-4xl bg-card p-8">
                <div className="mb-8 flex items-start justify-between">
                    ...
                    <div className="w-1/2 text-end">
                        <h2 className="mb-2 text-2xl font-bold">{t('SALES INVOICE')}</h2>
                ...
                <div className="mb-8 flex justify-between">
                    <div className="w-1/2">
                        <h3 className="mb-3 font-bold">{t('BILL TO')}</h3>
                        <div className="space-y-1 text-sm">
                ...
                <div className="border-t border-border pt-4 text-center">
                    ...
                    {invoice.zatca_qr && (
                        <div className="no-print-page-break mt-6 flex justify-center">
                            <img src={invoice.zatca_qr} alt="ZATCA e-Invoice QR" className="h-32 w-32 object-contain" />
                        </div>
                    )}
                </div>
            </div>

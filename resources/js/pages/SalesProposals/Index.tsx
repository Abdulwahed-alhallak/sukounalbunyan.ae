...
export default function Index() {
    ...
    const googleDriveButtons = usePageButtons('googleDriveBtn', {
        module: 'Proposal',
        settingKey: 'GoogleDrive Proposal',
    });
    ...
    const tableColumns = [
        ...
        },
        {
            ...
            sortable: true,
            render: (value: string) => (
                <span className={`rounded-full px-2 py-1 text-sm capitalize ${getProposalStatusColor(value)}`}>
                      ...
                      render: (_: any, item: SalesProposal) => (
                          <div className="flex gap-1">
                              <TooltipProvider>
                                      ...
                                      <Tooltip delayDuration={0}>
                                          <TooltipTrigger asChild>
                                              <Button
                                                  ...
                                                  onClick={() =>
                                                      window.open(
                                                          route('sales-proposals.print', item.id) + '?download=pdf',
                                                          '_blank'
                                                      )
                                                  }
                                          ...
                                          <Tooltip delayDuration={0}>
                                              <TooltipTrigger asChild>
                                                  <Button
                                                      ...
                                                      size="sm"
                                                      onClick={() =>
                                                          router.post(route('sales-proposals.sent', item.id))
                                                      }
                                                      className="h-8 w-8 p-0 text-foreground hover:text-foreground"
                                                  >
                                  ...
                                  {auth.user?.permissions?.includes('accept-sales-proposals') &&
                                      item.status === 'sent' && (
                                          <Tooltip delayDuration={0}>
                                              <TooltipTrigger asChild>
                                                  <Button
                                                      ...
                                                      size="sm"
                                                      onClick={() =>
                                                          router.post(route('sales-proposals.accept', item.id))
                                                      }
                                                      className="h-8 w-8 p-0 text-foreground hover:text-foreground"
                                                  >
                                              ...
                                              <TooltipContent>
                                                  <p>{t('Accept Proposal')}</p>
                                              </TooltipContent>
                                          </Tooltip>
                                      )}

                                  {auth.user?.permissions?.includes('reject-sales-proposals') &&
                                      item.status === 'sent' && (
                                          <Tooltip delayDuration={0}>
                                              <TooltipTrigger asChild>
                                                  <Button
                                                      ...
                                                      size="sm"
                                                      onClick={() =>
                                                          router.post(route('sales-proposals.reject', item.id))
                                                      }
                                      ...
                                      <Tooltip delayDuration={0}>
                                          <TooltipTrigger asChild>
                                              <Button
                                                  variant="ghost"
                                                  size="sm"
                                                  onClick={() => router.get(route('sales-proposals.show', item.id))}
                                                  className="h-8 w-8 p-0 text-foreground hover:text-foreground"
                                              >
                                          ...
                                          <Tooltip delayDuration={0}>
                                              <TooltipTrigger asChild>
                                                  <Button
                                                      ...
                                                      size="sm"
                                                      onClick={() =>
                                                          router.visit(route('sales-proposals.edit', item.id))
                                                      }
                                                      className="h-8 w-8 p-0 text-foreground hover:text-foreground"
                                                  >
                                  ...
                                  {item.status === 'draft' &&
                                      auth.user?.permissions?.includes('delete-sales-proposals') &&
                                      !item.converted_to_invoice && (
                                          <Tooltip delayDuration={0}>
                                              <TooltipTrigger asChild>
                                                  <Button
                                ...
                                {proposals?.data?.length > 0 ? (
                                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
                                        {proposals.data.map((proposal) => (
                                            <Card key={proposal.id} className="flex flex-col border border-border">
                                                    ...
                                                    <div className="mb-3 flex items-center justify-between">
                                                        {auth.user?.permissions?.includes('view-sales-proposals') ? (
                                                            <h3
                                                                ...
                                                                onClick={() =>
                                                                    router.get(
                                                                        route('sales-proposals.show', proposal.id)
                                                                    )
                                                                }
                                                            >
                                                        ...
                                                        <span
                                                            className={`rounded-full px-2 py-1 text-sm capitalize ${getProposalStatusColor(proposal.status)}`}
                                                        >
                                                    ...
                                                    <div className="mb-4 space-y-3">
                                                        ...
                                                        <div className="grid grid-cols-2 gap-3">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p
                                                                    className={`text-xs ${proposal.display_status === 'overdue' ? 'font-medium text-destructive' : 'text-foreground'}`}
                                                                >

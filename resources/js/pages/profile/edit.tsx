                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <Card className="shadow-sm min-h-[500px]">
                            <CardHeader className="border-b bg-muted/50/50">
                                ...
                                <p className="text-sm text-muted-foreground mt-1">{t('Details about your personal information')}</p>
                            </CardHeader>
                            <CardContent className="p-6">
                        ...
                        <Card className="shadow-sm min-h-[500px]">
                            <CardHeader className="border-b bg-muted/50/50">
                                ...
                                <p className="text-sm text-muted-foreground mt-1">{t('Details about your account password change')}</p>
                            </CardHeader>
                            <CardContent className="p-6">
                        ...
                        <div className="mt-6">
                            <Card className="shadow-sm">
                                <CardHeader className="border-b bg-muted/50/50">
                                    ...
                                    <p className="text-sm text-muted-foreground mt-1">{t('Complete your job seeker profile with this details')}</p>
                                </CardHeader>
                                <CardContent className="p-6">

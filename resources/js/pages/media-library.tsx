...
export default function MediaLibraryDemo() {
  ...
  const getFileIcon = (mimeType: string) => {
    ...
    if (mimeType.includes('pdf')) return <div className="h-4 w-4 bg-foreground rounded text-background text-xs flex items-center justify-center font-bold">PDF</div>;
    if (mimeType.includes('word') || mimeType.includes('document')) return <div className="h-4 w-4 bg-foreground rounded text-background text-xs flex items-center justify-center font-bold">DOC</div>;
    if (mimeType.includes('csv') || mimeType.includes('spreadsheet')) return <div className="h-4 w-4 bg-foreground rounded text-background text-xs flex items-center justify-center font-bold">CSV</div>;
    if (mimeType.startsWith('video/')) return <div className="h-4 w-4 bg-foreground rounded text-background text-xs flex items-center justify-center font-bold">VID</div>;
    if (mimeType.startsWith('audio/')) return <div className="h-4 w-4 bg-foreground rounded text-background text-xs flex items-center justify-center font-bold">AUD</div>;
    return <div className="h-4 w-4 bg-muted/500 rounded text-background text-xs flex items-center justify-center font-bold">FILE</div>;
  };
                  ...
                  {(currentDirectory !== null || showAllFiles) && currentMedia.map((item) => (
                    ...
                    >
                      ...
                      <div className="relative aspect-square bg-muted flex items-center justify-center">
                        ...
                        <div className="absolute inset-0 bg-foreground/0 group-hover:bg-foreground/10 transition-all duration-200" />

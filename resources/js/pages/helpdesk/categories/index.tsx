...
export default function Index() {
    ...
    const tableColumns = [
        ...
        },
        {
            ...
            render: (value: string) => (
                <div className="flex items-center gap-2">
                    <div className="h-4 w-4 rounded" style={{ backgroundColor: value }}></div>
                    <span>{value}</span>
                </div>
            ),
        },
        ...
        ...(auth.user?.permissions?.some((p: string) =>
            ['edit-helpdesk-categories', 'delete-helpdesk-categories'].includes(p)
        )
            ? [
                  {
                      key: 'actions',
        ...
        >
                ...
                <CardContent className="bg-muted/50/50 border-b p-6">
                    <div className="flex items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            <PerPageSelector routeName="helpdesk-categories.index" filters={{ name: searchName }} />
                        </div>
                    </div>
                </CardContent>
            ...
            <Dialog open={modalState.isOpen} onOpenChange={closeModal}>
                ...
                {modalState.mode === 'edit' && modalState.data && (
                    <Edit category={modalState.data} onSuccess={closeModal} />
                )}
            </Dialog>

...
export default function StorageSettings({ userSettings, auth }: StorageSettingsProps) {
    ...
    const handleFileTypeChange = (extension: string, checked: boolean) => {
        ...
        const newTypes = checked ? [...currentTypes, extension] : currentTypes.filter((type) => type !== extension);
    ...
    const filteredExtensions = useMemo(() => {
        return FILE_EXTENSIONS.filter((ext) => ext.toLowerCase().includes(searchTerm.toLowerCase()));
    }, [searchTerm]);
    ...
    const renderFileTypeSelector = () => (
        <div className="space-y-2">
            ...
            <div className="space-y-3">
                ...
                <div className="grid max-h-48 grid-cols-4 gap-2 overflow-y-auto rounded-md border p-4">

              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-col gap-3">
                      <div className="border rounded-md p-4 flex items-center justify-center bg-card h-32">
                        {settings.logo_light ? (
                          <img
                ...
                <div className={`flex flex-col space-y-8 ${!canEdit ? 'pointer-events-none opacity-60' : ''}`}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-6 gap-3 mb-2">
                      {Object.entries({ 
                        blue: '#3b82f6', green: '#10b77f', purple: '#8b5cf6', orange: '#f97316', red: '#ef4444', slate: '#475569',
                        cyan: '#06b6d4', indigo: '#4f46e5', pink: '#ec4899', rose: '#e11d48', amber: '#f59e0b',
                      }).map(([color, hex]) => (
                        <Button
                          key={color}
                          type="button"
                          variant={settings.themeColor === color ? "default" : "outline"}
                          className="h-10 w-full p-0 relative overflow-hidden transition-all duration-300 hover:shadow-md"
                          style={{ borderColor: settings.themeColor === color ? hex : 'transparent' }}
                          onClick={() => handleSelectChange('themeColor', color)}
                        >
                          <span
                            className="absolute inset-[3px] rounded-[6px] shadow-inner"
                            style={{ background: `linear-gradient(135deg, ${hex} 0%, ${hex}99 100%)` }}
                          />
                        </Button>
                      ))}
                      <Button
                        ...
                        className="h-10 w-full p-0 relative overflow-hidden transition-all duration-300 hover:shadow-md"
                        style={{ borderColor: settings.themeColor === 'custom' ? settings.customColor : 'transparent' }}
                        onClick={() => handleSelectChange('themeColor', 'custom')}
                      >
                        <span
                          className="absolute inset-[3px] rounded-[6px] shadow-inner flex items-center justify-center bg-card/20"
                          style={{ background: `linear-gradient(135deg, ${settings.customColor} 0%, ${settings.customColor}99 100%)` }}
                        >
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="Inter">{t('Inter (Modern Sans)')}</SelectItem>
                            <SelectItem value="Cairo">{t('Cairo (Modern Arabic)')}</SelectItem>
                            <SelectItem value="Poppins">{t('Poppins (Geometric)')}</SelectItem>
                            <SelectItem value="Roboto">{t('Roboto (Technical)')}</SelectItem>
                      ...
                      <div className="p-4 border rounded-lg bg-muted/50 dark:bg-foreground overflow-hidden">
                        <div style={{ fontFamily: settings.fontFamily }} className="space-y-2">
                           ...
                           <p className="text-lg font-bold" dir="rtl">الثعلب البني السريع يقفز فوق الكلب الكسول.</p>
                        </div>
                      </div>
                    </div>
                  </div>
